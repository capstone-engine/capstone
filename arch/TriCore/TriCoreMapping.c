...
tricore_reg TriCore_map_register(unsigned int r)
{
	static unsigned int map[] = { 0,
		TRICORE_REG_FCX, TRICORE_REG_PC, TRICORE_REG_PCXI, TRICORE_REG_PSW, 
		...
		TRICORE_REG_E0, TRICORE_REG_E2, TRICORE_REG_E4, TRICORE_REG_E6,
		TRICORE_REG_E8, TRICORE_REG_E10, TRICORE_REG_E12, TRICORE_REG_E14,
	};
