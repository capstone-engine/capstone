...
static const name_map reg_name_maps[] = {
    ...
    {SystemZ_R0D, "0"},       {SystemZ_R1D, "1"},    {SystemZ_R2D, "2"},
    {SystemZ_R3D, "3"},       {SystemZ_R4D, "4"},    {SystemZ_R5D, "5"},
    {SystemZ_R6D, "6"},       {SystemZ_R7D, "7"},    {SystemZ_R8D, "8"},
    {SystemZ_R9D, "9"},       {SystemZ_R10D, "10"},  {SystemZ_R11D, "11"},
    {SystemZ_R12D, "12"},     {SystemZ_R13D, "13"},  {SystemZ_R14D, "14"},
    {SystemZ_R15D, "15"},     {SystemZ_R0L, "0"},    {SystemZ_R1L, "1"},
    {SystemZ_R2L, "2"},       {SystemZ_R3L, "3"},    {SystemZ_R4L, "4"},
    {SystemZ_R5L, "5"},       {SystemZ_R6L, "6"},    {SystemZ_R7L, "7"},
    {SystemZ_R8L, "8"},       {SystemZ_R9L, "9"},    {SystemZ_R10L, "10"},
    {SystemZ_R11L, "11"},     {SystemZ_R12L, "12"},  {SystemZ_R13L, "13"},
    {SystemZ_R14L, "14"},     {SystemZ_R15L, "15"},  {SystemZ_R0H, "0"},
    {SystemZ_R1H, "1"},       {SystemZ_R2H, "2"},    {SystemZ_R3H, "3"},
    {SystemZ_R4H, "4"},       {SystemZ_R5H, "5"},    {SystemZ_R6H, "6"},
    {SystemZ_R7H, "7"},       {SystemZ_R8H, "8"},    {SystemZ_R9H, "9"},
    {SystemZ_R10H, "10"},     {SystemZ_R11H, "11"},  {SystemZ_R12H, "12"},
    {SystemZ_R13H, "13"},     {SystemZ_R14H, "14"},  {SystemZ_R15H, "15"},
    {SystemZ_R0Q, "0"},       {SystemZ_R2Q, "2"},    {SystemZ_R4Q, "4"},
    {SystemZ_R6Q, "6"},       {SystemZ_R8Q, "8"},    {SystemZ_R10Q, "10"},
    {SystemZ_R12Q, "12"},     {SystemZ_R14Q, "14"},  {SystemZ_CC, "cc"},
    {SystemZ_F0D, "f0"},      {SystemZ_F1D, "f1"},   {SystemZ_F2D, "f2"},
    {SystemZ_F3D, "f3"},      {SystemZ_F4D, "f4"},   {SystemZ_F5D, "f5"},
    {SystemZ_F6D, "f6"},      {SystemZ_F7D, "f7"},   {SystemZ_F8D, "f8"},
    {SystemZ_F9D, "f9"},      {SystemZ_F10D, "f10"}, {SystemZ_F11D, "f11"},
    {SystemZ_F12D, "f12"},    {SystemZ_F13D, "f13"}, {SystemZ_F14D, "f14"},
    {SystemZ_F15D, "f15"},    {SystemZ_R0L, "r0l"},  {SystemZ_A0, "a0"},
    {SystemZ_A1, "a1"},       {SystemZ_A2, "a2"},    {SystemZ_A3, "a3"},
    {SystemZ_A4, "a4"},       {SystemZ_A5, "a5"},    {SystemZ_A6, "a6"},
    {SystemZ_A7, "a7"},       {SystemZ_A8, "a8"},    {SystemZ_A9, "a9"},
    {SystemZ_A10, "a10"},     {SystemZ_A11, "a11"},  {SystemZ_A12, "a12"},
    {SystemZ_A13, "a13"},     {SystemZ_A14, "a14"},  {SystemZ_A15, "a15"},
    {SystemZ_C0, "c0"},       {SystemZ_C1, "c1"},    {SystemZ_C2, "c2"},
    {SystemZ_C3, "c3"},       {SystemZ_C4, "c4"},    {SystemZ_C5, "c5"},
    {SystemZ_C6, "c6"},       {SystemZ_C7, "c7"},    {SystemZ_C8, "c8"},
    {SystemZ_C9, "c9"},       {SystemZ_C10, "c10"},  {SystemZ_C11, "c11"},
    {SystemZ_C12, "c12"},     {SystemZ_C13, "c13"},  {SystemZ_C14, "c14"},
    {SystemZ_C15, "c15"},     {SystemZ_V0, "v0"},    {SystemZ_V1, "v1"},
    {SystemZ_V2, "v2"},       {SystemZ_V3, "v3"},    {SystemZ_V4, "v4"},
    {SystemZ_V5, "v5"},       {SystemZ_V6, "v6"},    {SystemZ_V7, "v7"},
    {SystemZ_V8, "v8"},       {SystemZ_V9, "v9"},    {SystemZ_V10, "v10"},
    {SystemZ_V11, "v11"},     {SystemZ_V12, "v12"},  {SystemZ_V13, "v13"},
    {SystemZ_V14, "v14"},     {SystemZ_V15, "v15"},  {SystemZ_V16, "v16"},
    {SystemZ_V17, "v17"},     {SystemZ_V18, "v18"},  {SystemZ_V19, "v19"},
    {SystemZ_V20, "v20"},     {SystemZ_V21, "v21"},  {SystemZ_V22, "v22"},
    {SystemZ_V23, "v23"},     {SystemZ_V24, "v24"},  {SystemZ_V25, "v25"},
    {SystemZ_V26, "v26"},     {SystemZ_V27, "v27"},  {SystemZ_V28, "v28"},
    {SystemZ_V29, "v29"},     {SystemZ_V30, "v30"},  {SystemZ_V31, "v31"},
    {SystemZ_F16D, "f16"},    {SystemZ_F17D, "f17"}, {SystemZ_F18D, "f18"},
    {SystemZ_F19D, "f19"},    {SystemZ_F20D, "f20"}, {SystemZ_F21D, "f21"},
    {SystemZ_F22D, "f22"},    {SystemZ_F23D, "f23"}, {SystemZ_F24D, "f24"},
    {SystemZ_F25D, "f25"},    {SystemZ_F26D, "f26"}, {SystemZ_F27D, "f27"},
    {SystemZ_F28D, "f28"},    {SystemZ_F29D, "f29"}, {SystemZ_F30D, "f30"},
    {SystemZ_F31D, "f31"},    {SystemZ_F0Q, "f0q"},  {SystemZ_F4Q, "f4q"},
};
#endif
