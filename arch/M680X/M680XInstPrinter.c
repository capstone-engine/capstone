...
static const char s_instruction_names[][6] =
{
 ...
 "ASR", "ASRA", "ASRB",
 "BAND",
 "BCC", "BCS", "BEOR", "BEQ", "BGE", "BGT", "BHI", "BIAND", "BIEOR", "BIOR",
 "BITA", "BITB", "BITD", "BITMD", "BLE", "BLS", "BLT", "BMI", "BNE", "BOR",
 ...
 "LDA", "LDAA", "LDAB", "LDB", "LDBT", "LDD", "LDE", "LDF", "LDMD", "LDQ",
 "LDS", "LDU", "LDW", "LDX", "LDY",
 "LEAS", "LEAU", "LEAX", "LEAY",
 "LSL", "LSLA", "LSLB",
 ...
 "SEC", "SEI", "SEV", "SEX", "SEXW", "STA", "STAA", "STAB", "STB", "STBT",
 "STD", "STE", "STF", "STQ", "STS", "STU", "STW", "STX", "STY",
...
cs_err M680X_instprinter_init(cs_struct *ud)
{
  ...
  {
    fprintf(stderr, "Internal error: Size mismatch in enum m680x_group_type "
            "and s_group_names\n");
