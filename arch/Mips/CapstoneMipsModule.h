...
static DecodeStatus DecodeINSVE_DF(MCInst *MI, unsigned insn, uint64_t Address,
                                   void *Decoder) {
  DecodeStatus (*RegDecoder)(MCInst *, unsigned, uint64_t, void *);
...
static DecodeStatus DecodeBranchTargetMM(MCInst *Inst, unsigned Offset,
                                         uint64_t Address, void *Decoder) {
  // llvm has a plus 4 out here - which turns out to be inconsitent with our
  // test suite
