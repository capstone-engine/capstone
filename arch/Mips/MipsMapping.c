...
static const name_map reg_name_maps[] = {
    ...
    {Mips_DSPCCond, "dspccond"},
    {Mips_DSPCarry, "dspcarry"},
    {Mips_DSPEFI, "dspefi"},
    {Mips_DSPOutFlag, "dspoutflag"},
    {Mips_DSPOutFlag16_19, "dspoutflag16_19"},
    {Mips_DSPOutFlag20, "dspoutflag20"},
    {Mips_DSPOutFlag21, "dspoutflag21"},
    {Mips_DSPOutFlag22, "dspoutflag22"},
    {Mips_DSPOutFlag23, "dspoutflag23"},
    {Mips_DSPPos, "dsppos"},
    {Mips_DSPSCount, "dspscount"},
...
{
#ifndef CAPSTONE_DIET
  for(unsigned i = 0; i < ARR_SIZE(reg_name_maps); i ++)
    if(reg_name_maps[i].id == reg)
      return (const char *)reg_name_maps[i].name;
