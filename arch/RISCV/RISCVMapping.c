...
static const name_map reg_name_maps[] = {
    ...
    {RISCV_X0, "zero"},        {RISCV_X1, "ra"},      {RISCV_X2, "sp"},
    {RISCV_X3, "gp"},          {RISCV_X4, "tp"},      {RISCV_X5, "t0"},
    {RISCV_X6, "t1"},          {RISCV_X7, "t2"},      {RISCV_X8, "s0"},
    ...
    {RISCV_X30, "t5"},         {RISCV_X31, "t6"},

    {RISCV_F0_F, "ft0"},       {RISCV_F0_D, "ft0"},   {RISCV_F1_F, "ft1"},
    {RISCV_F1_D, "ft1"},       {RISCV_F2_F, "ft2"},   {RISCV_F2_D, "ft2"},
    {RISCV_F3_F, "ft3"},       {RISCV_F3_D, "ft3"},   {RISCV_F4_F, "ft4"},
    {RISCV_F4_D, "ft4"},       {RISCV_F5_F, "ft5"},   {RISCV_F5_D, "ft5"},
    {RISCV_F6_F, "ft6"},       {RISCV_F6_D, "ft6"},   {RISCV_F7_F, "ft7"},
    {RISCV_F7_D, "ft7"},       {RISCV_F8_F, "fs0"},   {RISCV_F8_D, "fs0"},
    {RISCV_F9_F, "fs1"},       {RISCV_F9_D, "fs1"},   {RISCV_F10_F, "fa0"},
    {RISCV_F10_D, "fa0"},      {RISCV_F11_F, "fa1"},  {RISCV_F11_D, "fa1"},
    {RISCV_F12_F, "fa2"},      {RISCV_F12_D, "fa2"},  {RISCV_F13_F, "fa3"},
    {RISCV_F13_D, "fa3"},      {RISCV_F14_F, "fa4"},  {RISCV_F14_D, "fa4"},
    {RISCV_F15_F, "fa5"},      {RISCV_F15_D, "fa5"},  {RISCV_F16_F, "fa6"},
    {RISCV_F16_D, "fa6"},      {RISCV_F17_F, "fa7"},  {RISCV_F17_D, "fa7"},
    {RISCV_F18_F, "fs2"},      {RISCV_F18_D, "fs2"},  {RISCV_F19_F, "fs3"},
    {RISCV_F19_D, "fs3"},      {RISCV_F20_F, "fs4"},  {RISCV_F20_D, "fs4"},
    {RISCV_F21_F, "fs5"},      {RISCV_F21_D, "fs5"},  {RISCV_F22_F, "fs6"},
    {RISCV_F22_D, "fs6"},      {RISCV_F23_F, "fs7"},  {RISCV_F23_D, "fs7"},
    {RISCV_F24_F, "fs8"},      {RISCV_F24_D, "fs8"},  {RISCV_F25_F, "fs9"},
    {RISCV_F25_D, "fs9"},      {RISCV_F26_F, "fs10"}, {RISCV_F26_D, "fs10"},
    {RISCV_F27_F, "fs11"},     {RISCV_F27_D, "fs11"}, {RISCV_F28_F, "ft8"},
    {RISCV_F28_D, "ft8"},      {RISCV_F29_F, "ft9"},  {RISCV_F29_D, "ft9"},
    {RISCV_F30_F, "ft10"},     {RISCV_F30_D, "ft10"}, {RISCV_F31_F, "ft11"},
    {RISCV_F31_D, "ft11"},
};
#endif
...
#ifndef CAPSTONE_DIET
static const name_map group_name_maps[] = {{RISCV_GRP_INVALID, NULL},
                                           {RISCV_GRP_JUMP, "jump"},
...
#ifndef CAPSTONE_DIET
  // verify group id
  if (id >= RISCV_GRP_ENDING || (id > RISCV_GRP_JUMP && id < RISCV_GRP_ISRV32))
    return NULL;
