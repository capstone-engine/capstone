...
static void addImplySP(MCInst *Inst, int64_t Address, const void *Decoder) {
  if (MCInst_getOpcode() == RISCV_C_LWSP || MCInst_getOpcode() == RISCV_C_SWSP ||
      MCInst_getOpcode() == RISCV_C_LDSP || MCInst_getOpcode() == RISCV_C_SDSP ||
      MCInst_getOpcode() == RISCV_C_FLWSP ||
      MCInst_getOpcode() == RISCV_C_FSWSP ||
      MCInst_getOpcode() == RISCV_C_FLDSP ||
      MCInst_getOpcode() == RISCV_C_FSDSP ||
      MCInst_getOpcode() == RISCV_C_ADDI4SPN) {
    DecodeGPRRegisterClass(Inst, 2, Address, Decoder);
  }
  if (Inst.getOpcode() == RISCV_C_ADDI16SP) {
    DecodeGPRRegisterClass(Inst, 2, Address, Decoder);
    DecodeGPRRegisterClass(Inst, 2, Address, Decoder);
  }
}
