...
static const name_map reg_name_maps[] = {
    ...
    /*    {PPC_Q0, "q0"},         {PPC_Q1, "q1"},
        ...
        {PPC_Q6, "q6"},         {PPC_Q7, "q7"},
        {PPC_Q8, "q8"},         {PPC_Q9, "q9"},
        {PPC_Q10, "q10"},       {PPC_Q11, "q11"},
        {PPC_Q12, "q12"},       {PPC_Q13, "q13"},
        {PPC_Q14, "q14"},       {PPC_Q15, "q15"},
        {PPC_Q16, "q16"},       {PPC_Q17, "q17"},
        {PPC_Q18, "q18"},       {PPC_Q19, "q19"},
        {PPC_Q20, "q20"},       {PPC_Q21, "q21"},
        {PPC_Q22, "q22"},       {PPC_Q23, "q23"},
        {PPC_Q24, "q24"},       {PPC_Q25, "q25"},
        {PPC_Q26, "q26"},       {PPC_Q27, "q27"},
        {PPC_Q28, "q28"},       {PPC_Q29, "q29"},
        {PPC_Q30, "q30"},       {PPC_Q31, "q31"}, */
    {PPC_R0, "r0"},
    {PPC_R1, "r1"},
    {PPC_R2, "r2"},
    {PPC_R3, "r3"},
    ...
    {PPC_V30, "v30"},
    {PPC_V31, "v31"},
    /*    {PPC_VS0, "vs0"},       {PPC_VS1, "vs1"},
        {PPC_VS2, "vs2"},       {PPC_VS3, "vs3"},
        {PPC_VS4, "vs4"},       {PPC_VS5, "vs5"},
        {PPC_VS6, "vs6"},       {PPC_VS7, "vs7"},
        {PPC_VS8, "vs8"},       {PPC_VS9, "vs9"},
        {PPC_VS10, "vs10"},     {PPC_VS11, "vs11"},
        {PPC_VS12, "vs12"},     {PPC_VS13, "vs13"},
        {PPC_VS14, "vs14"},     {PPC_VS15, "vs15"},
        {PPC_VS16, "vs16"},     {PPC_VS17, "vs17"},
        {PPC_VS18, "vs18"},     {PPC_VS19, "vs19"},
        {PPC_VS20, "vs20"},     {PPC_VS21, "vs21"},
        {PPC_VS22, "vs22"},     {PPC_VS23, "vs23"},
        {PPC_VS24, "vs24"},     {PPC_VS25, "vs25"},
        {PPC_VS26, "vs26"},     {PPC_VS27, "vs27"},
        {PPC_VS28, "vs28"},     {PPC_VS29, "vs29"},
        {PPC_VS30, "vs30"},     {PPC_VS31, "vs31"},
        {PPC_VS32, "vs32"},     {PPC_VS33, "vs33"},
        {PPC_VS34, "vs34"},     {PPC_VS35, "vs35"},
        {PPC_VS36, "vs36"},     {PPC_VS37, "vs37"},
        {PPC_VS38, "vs38"},     {PPC_VS39, "vs39"},
        {PPC_VS40, "vs40"},     {PPC_VS41, "vs41"},
        {PPC_VS42, "vs42"},     {PPC_VS43, "vs43"},
        {PPC_VS44, "vs44"},     {PPC_VS45, "vs45"},
        {PPC_VS46, "vs46"},     {PPC_VS47, "vs47"},
        {PPC_VS48, "vs48"},     {PPC_VS49, "vs49"},
        {PPC_VS50, "vs50"},     {PPC_VS51, "vs51"},
        {PPC_VS52, "vs52"},     {PPC_VS53, "vs53"},
        {PPC_VS54, "vs54"},     {PPC_VS55, "vs55"},
        {PPC_VS56, "vs56"},     {PPC_VS57, "vs57"},
        {PPC_VS58, "vs58"},     {PPC_VS59, "vs59"},
        {PPC_VS60, "vs60"},     {PPC_VS61, "vs61"},
        {PPC_VS62, "vs62"},     {PPC_VS63, "vs63"}, */
    {PPC_CR0EQ, "cr0eq"},
    {PPC_CR1EQ, "cr1eq"},
    {PPC_CR2EQ, "cr2eq"},
    {PPC_CR3EQ, "cr3eq"},
