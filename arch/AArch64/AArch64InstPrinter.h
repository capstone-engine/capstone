...
void printInst(MCInst *MI, uint64_t Address, const char *Annot,
			   SStream *O);
void printRegName(SStream *OS, unsigned Reg, unsigned AltIdx);
// Autogenerated by tblgen.
MnemonicBitsInfo getMnemonic(MCInst *MI);
void printInstruction(MCInst *MI, uint64_t Address, SStream *O);
bool printAliasInstr(MCInst *MI, uint64_t Address, SStream *O);
void printCustomAliasOperand(MCInst *MI, uint64_t Address,
...
void printImmSVE(uint64_t Value, SStream *O);
