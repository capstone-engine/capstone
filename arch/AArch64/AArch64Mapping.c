...
static insn_op insn_ops[] = 
	...
	{    /* AArch64_ADDSWri, ARM64_INS_ADDS: adds    $rd, $rn, $imm */
		0,
		{  CS_OP_READ, CS_OP_READ, CS_OP_READ,0 }
	},
	...
	{    /* AArch64_BFMWri, ARM64_INS_BFM: bfm    $rd, $rn, $immr, $imms */
		0,
		{ CS_OP_READ | CS_OP_WRITE, CS_OP_READ, CS_OP_READ, CS_OP_READ, 0 }
	},
	...
	{    /* AArch64_BIFv16i8, ARM64_INS_BIF: bif.16b    $rd, $rn, $rm| */
		0,
		{ CS_OP_READ | CS_OP_WRITE, CS_OP_READ, CS_OP_READ, 0 }
	},
	...
	{    /* AArch64_CCMNWi, ARM64_INS_CCMN: ccmn    $rn, $imm, $nzcv, $cond */
		0,
		{ CS_OP_READ, CS_OP_READ, CS_OP_READ, CS_OP_READ, 0 }
	},
	...
	{    /* AArch64_FCCMPDrr, ARM64_INS_FCCMP: fccmp    $rn, $rm, $nzcv, $cond */
		0,
		{ CS_OP_READ, CS_OP_READ, CS_OP_WRITE, CS_OP_READ, 0 }
	},
	...
	{    /* AArch64_FMLAv1i64_indexed, ARM64_INS_FMLA: fmla.d    $rd, $rn, $rm$idx */
		0,
		{ CS_OP_WRITE | CS_OP_READ, CS_OP_READ, CS_OP_READ, CS_OP_READ, 0 }
	},
	...
	{    /* AArch64_LD1Fourv16b, ARM64_INS_LD1: ld1    $vt, [$rn] */
		0,
		{ CS_OP_WRITE | CS_OP_READ, CS_OP_WRITE | CS_OP_READ, 0 }
	},
	{    /* AArch64_LD1Fourv16b_POST, ARM64_INS_LD1: ld1    $vt, [$rn], $xm */
		0,
		{ CS_OP_WRITE | CS_OP_READ, CS_OP_WRITE | CS_OP_READ, CS_OP_READ, 0 }
	},
	...
	{    /* AArch64_LD1Onev2d_POST, ARM64_INS_LD1: ld1    $vt, [$rn], $xm */
		0,
		{ CS_OP_WRITE | CS_OP_READ, CS_OP_WRITE | CS_OP_READ, CS_OP_READ0 }
	},
	...
	{    /* AArch64_LD3i16, ARM64_INS_LD3: ld3    $vt$idx, [$rn] */
		0,
		{ CS_OP_WRITE | CS_OP_READ, CS_OP_READ, CS_OP_WRITE | CS_OP_READ, 0 }
	},
	{    /* AArch64_LD3i16_POST, ARM64_INS_LD3: ld3    $vt$idx, [$rn], $xm */
		0,
		{ CS_OP_WRITE | CS_OP_READ, CS_OP_READ, CS_OP_WRITE | CS_OP_READ, CS_OP_READ, 0 }
	},
	...
	{    /* AArch64_LDNPDi, ARM64_INS_LDNP: ldnp    $rt, $rt2, [$rn, $offset] */
		0,
		{ CS_OP_WRITE | CS_OP_READ, CS_OP_WRITE | CS_OP_READ, CS_OP_WRITE | CS_OP_READ, CS_OP_READ, 0 }
	},
	...
	{    /* AArch64_LDRBBroW, ARM64_INS_LDRB: ldrb    $rt, [$rn, $rm, $extend] */
		0,
		{ CS_OP_WRITE | CS_OP_READ, CS_OP_WRITE | CS_OP_READ, CS_OP_READ, CS_OP_READ, 0 }
	},
	...
	{    /* AArch64_STLXPW, ARM64_INS_STLXP: stlxp    $ws, $rt, $rt2, [$rn] */
		0,
		{ CS_OP_WRITE, CS_OP_WRITE | CS_OP_READ, CS_OP_WRITE | CS_OP_READ, CS_OP_READ, 0 }
	},
	...
	{    /* AArch64_SYSLxt, ARM64_INS_SYSL: sysl    $rt, $op1, $cn, $cm, $op2 */
		0,
		{ CS_OP_WRITE | CS_OP_READ, CS_OP_READ, CS_OP_READ, CS_OP_READ, CS_OP_READ, 0 }
	},
	{    /* AArch64_SYSxt, ARM64_INS_SYS: sys    $op1, $cn, $cm, $op2, $rt */
		0,
		{ CS_OP_READ, CS_OP_READ, CS_OP_READ, CS_OP_READ, CS_OP_WRITE | CS_OP_READ, 0 }
	},
