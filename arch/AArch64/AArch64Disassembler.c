...
static DecodeStatus DecodeSVELogicalImmInstruction(MCInst *Inst,
                                                   ...
                                                   uint64_t Address,
                                                   const void *Decoder);
static DecodeStatus DecodeSImm(MCInst *Inst, uint64_t Imm,
                               uint64_t Address, const void *Decoder);
...
static bool Check(DecodeStatus *Out, DecodeStatus In) {
  ...
  // ållvm_unreachable("Invalid DecodeStatus!");
}
...
//                                      MCInst_getOpcode(Inst)!= AArch64_LDRXl, 0, 4))
...
static DecodeStatus DecodeXSeqPairsClassRegisterClass(MCInst *Inst,
                                                      ...
                                                      const void *Decoder) {
  return DecodeGPRSeqPairsClassRegisterClass(Inst,
                                             AArch64_XSeqPairsClassRegClassID,
                                             RegNo, Addr, Decoder);
}
