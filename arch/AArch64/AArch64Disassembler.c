...
void AArch64_init(MCRegisterInfo *MRI) {
  /*
     InitMCRegisterInfo(AArch64RegDesc, 661,
                  ...
                  AArch64LaneMaskLists, AArch64RegStrings,
     AArch64RegClassStrings, AArch64SubRegIdxLists, 100, AArch64SubRegIdxRanges,
     AArch64RegEncodingTable);
  */
  MCRegisterInfo_InitMCRegisterInfo(
      MRI, AArch64RegDesc, ARR_SIZE(AArch64RegDesc), 0, 0,
      AArch64MCRegisterClasses, ARR_SIZE(AArch64MCRegisterClasses), 0, 0,
      AArch64RegDiffLists, 0, AArch64SubRegIdxLists,
