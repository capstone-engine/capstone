...
static insn_op insn_ops[] = {
	...
	{	/* ARM_MCR, ARM_INS_MCR: mcr${p}	$cop, $opc1, $rt, $crn, $crm, $opc2 */
		0,
		{ CS_OP_NOREG, CS_OP_NOREG, CS_OP_READ, CS_OP_NOREG, CS_OP_NOREG, CS_OP_NOREG, 0 }
	},
	...
	{	/* ARM_MCRR, ARM_INS_MCRR: mcrr${p}	$cop, $opc1, $rt, $rt2, $crm */
		0,
		{ CS_OP_NOREG, CS_OP_NOREG, CS_OP_READ, CS_OP_READ, CS_OP_NOREG, 0 }
	},
	...
	{	/* ARM_VLD3d16, ARM_INS_VLD3: vld3${p}.16	\{$vd, $dst2, $dst3\}, $rn */
		0,
		{ CS_OP_NOREG, CS_OP_WRITE, CS_OP_NOREG, CS_OP_NOREG, 0 }
	},
	...
	{	/* ARM_VLD4d16, ARM_INS_VLD4: vld4${p}.16	\{$vd, $dst2, $dst3, $dst4\}, $rn */
		0,
		{ CS_OP_NOREG, CS_OP_WRITE, CS_OP_WRITE, CS_OP_NOREG, CS_OP_NOREG, 0 }
	},
	...
	{	/* ARM_VMOVRRD, ARM_INS_VMOV: vmov${p}	$rt, $rt2, $dm */
		0,
		{ CS_OP_WRITE, CS_OP_WRITE, CS_OP_READ, 0 }
	},
	...
	{	/* ARM_VST3d16, ARM_INS_VST3: vst3${p}.16	\{$vd, $src2, $src3\}, $rn */
		0,
		{ CS_OP_NOREG, CS_OP_READ, CS_OP_NOREG, CS_OP_NOREG, 0 }
	},
	...
	{	/* ARM_VST4d16, ARM_INS_VST4: vst4${p}.16	\{$vd, $src2, $src3, $src4\}, $rn */
		0,
		{ CS_OP_NOREG, CS_OP_READ, CS_OP_READ, CS_OP_NOREG, CS_OP_NOREG, 0 }
	},
