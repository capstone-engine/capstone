//===-- X86NasmInstPrinter.cpp - Nasm assembly instruction printing -----===//
//
...
//===----------------------------------------------------------------------===//
//
// This file includes code for rendering MCInst instances as Nasm-style
// assembly.
// nasm-website£ºhttp://www.nasm.us/
//===----------------------------------------------------------------------===//

/* Capstone Disassembly Engine */
/* By Nguyen Anh Quynh <aquynh@gmail.com>, 2013-2014 */
/* By Tennn <stonedreamforest@gmail.com>, 2017.8.26*/
...
void X86_Nasm_printInst(MCInst *MI , SStream *O , void *Info) {
	x86_reg reg , reg2;
#ifndef CAPSTONE_DIET
	char *mnem;
		...
		switch (MI->flat_insn->id) {
			...
			case X86_INS_RET:
				...
				if (imm >= 0 && imm <= HEX_THRESHOLD)
					...
					imm = 0xffff & imm;
					SStream_concat(O , "0%x""h" , 0xffff & imm);
				}
				break;
		}
