...
- Added `CS_MODE_X86_JCC_INTEL` and `CS_MODE_X86_JCC_AMD` to select how `66`-prefixed near conditional jumps are decoded in 64-bit mode.
  Without either flag, the previous behavior is preserved.
