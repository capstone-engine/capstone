...
0xc5,0xc8,0xc2,0x08,0x00 = vcmpps $0, 0(%eax), %xmm6, %xmm1
0xc5,0xc8,0xc2,0xc8,0x07 = vcmpps $7, %xmm0, %xmm6, %xmm1
0xc5,0xc9,0xc2,0xc8,0x00 = vcmppd $0, %xmm0, %xmm6, %xmm1
0xc5,0xc9,0xc2,0x08,0x00 = vcmppd $0, 0(%eax), %xmm6, %xmm1
...
0xc5,0xf8,0x2e,0x10 = vucomiss 0(%eax), %xmm2
0xc5,0xf8,0x2f,0xd1 = vcomiss %xmm1, %xmm2
0xc5,0xf8,0x2f,0x10 = vcomiss 0(%eax), %xmm2
0xc5,0xf9,0x2e,0xd1 = vucomisd %xmm1, %xmm2
0xc5,0xf9,0x2e,0x10 = vucomisd 0(%eax), %xmm2
0xc5,0xf9,0x2f,0xd1 = vcomisd %xmm1, %xmm2
0xc5,0xf9,0x2f,0x10 = vcomisd 0(%eax), %xmm2
0xc5,0xfa,0x2c,0xc1 = vcvttss2si %xmm1, %eax
0xc5,0xfa,0x2c,0x01 = vcvttss2si 0(%ecx), %eax
0xc5,0xf2,0x2a,0x10 = vcvtsi2ssl 0(%eax), %xmm1, %xmm2
0xc5,0xf2,0x2a,0x10 = vcvtsi2ssl 0(%eax), %xmm1, %xmm2
0xc5,0xf2,0x2a,0x10 = vcvtsi2ssl 0(%eax), %xmm1, %xmm2
0xc5,0xf2,0x2a,0x10 = vcvtsi2ssl 0(%eax), %xmm1, %xmm2
0xc5,0xfb,0x2c,0xc1 = vcvttsd2si %xmm1, %eax
0xc5,0xfb,0x2c,0x01 = vcvttsd2si 0(%ecx), %eax
0xc5,0xf3,0x2a,0x10 = vcvtsi2sdl 0(%eax), %xmm1, %xmm2
0xc5,0xf3,0x2a,0x10 = vcvtsi2sdl 0(%eax), %xmm1, %xmm2
0xc5,0xf3,0x2a,0x10 = vcvtsi2sdl 0(%eax), %xmm1, %xmm2
0xc5,0xf3,0x2a,0x10 = vcvtsi2sdl 0(%eax), %xmm1, %xmm2
0xc5,0xf8,0x28,0x10 = vmovaps 0(%eax), %xmm2
0xc5,0xf8,0x28,0xd1 = vmovaps %xmm1, %xmm2
0xc5,0xf8,0x29,0x08 = vmovaps %xmm1, 0(%eax)
0xc5,0xf9,0x28,0x10 = vmovapd 0(%eax), %xmm2
0xc5,0xf9,0x28,0xd1 = vmovapd %xmm1, %xmm2
0xc5,0xf9,0x29,0x08 = vmovapd %xmm1, 0(%eax)
0xc5,0xf8,0x10,0x10 = vmovups 0(%eax), %xmm2
0xc5,0xf8,0x10,0xd1 = vmovups %xmm1, %xmm2
0xc5,0xf8,0x11,0x08 = vmovups %xmm1, 0(%eax)
0xc5,0xf9,0x10,0x10 = vmovupd 0(%eax), %xmm2
0xc5,0xf9,0x10,0xd1 = vmovupd %xmm1, %xmm2
0xc5,0xf9,0x11,0x08 = vmovupd %xmm1, 0(%eax)
0xc5,0xf8,0x13,0x08 = vmovlps %xmm1, 0(%eax)
0xc5,0xe8,0x12,0x18 = vmovlps 0(%eax), %xmm2, %xmm3
0xc5,0xf9,0x13,0x08 = vmovlpd %xmm1, 0(%eax)
0xc5,0xe9,0x12,0x18 = vmovlpd 0(%eax), %xmm2, %xmm3
0xc5,0xf8,0x17,0x08 = vmovhps %xmm1, 0(%eax)
0xc5,0xe8,0x16,0x18 = vmovhps 0(%eax), %xmm2, %xmm3
0xc5,0xf9,0x17,0x08 = vmovhpd %xmm1, 0(%eax)
0xc5,0xe9,0x16,0x18 = vmovhpd 0(%eax), %xmm2, %xmm3
...
0xc5,0xfa,0x2d,0x18 = vcvtss2si 0(%eax), %ebx
0xc5,0xfa,0x2d,0xc1 = vcvtss2si %xmm1, %eax
0xc5,0xfa,0x2d,0x18 = vcvtss2si 0(%eax), %ebx
0xc5,0xf8,0x5b,0xf5 = vcvtdq2ps %xmm5, %xmm6
0xc5,0xf8,0x5b,0x30 = vcvtdq2ps 0(%eax), %xmm6
0xc5,0xdb,0x5a,0xf2 = vcvtsd2ss %xmm2, %xmm4, %xmm6
0xc5,0xdb,0x5a,0x30 = vcvtsd2ss 0(%eax), %xmm4, %xmm6
0xc5,0xf9,0x5b,0xda = vcvtps2dq %xmm2, %xmm3
0xc5,0xf9,0x5b,0x18 = vcvtps2dq 0(%eax), %xmm3
0xc5,0xda,0x5a,0xf2 = vcvtss2sd %xmm2, %xmm4, %xmm6
0xc5,0xda,0x5a,0x30 = vcvtss2sd 0(%eax), %xmm4, %xmm6
0xc5,0xf8,0x5b,0xf4 = vcvtdq2ps %xmm4, %xmm6
0xc5,0xf8,0x5b,0x21 = vcvtdq2ps 0(%ecx), %xmm4
0xc5,0xfa,0x5b,0xda = vcvttps2dq %xmm2, %xmm3
0xc5,0xfa,0x5b,0x18 = vcvttps2dq 0(%eax), %xmm3
0xc5,0xf8,0x5a,0xda = vcvtps2pd %xmm2, %xmm3
0xc5,0xf8,0x5a,0x18 = vcvtps2pd 0(%eax), %xmm3
0xc5,0xf9,0x5a,0xda = vcvtpd2ps %xmm2, %xmm3
0xc5,0xf9,0x51,0xd1 = vsqrtpd %xmm1, %xmm2
0xc5,0xf9,0x51,0x10 = vsqrtpd 0(%eax), %xmm2
0xc5,0xf8,0x51,0xd1 = vsqrtps %xmm1, %xmm2
0xc5,0xf8,0x51,0x10 = vsqrtps 0(%eax), %xmm2
0xc5,0xeb,0x51,0xd9 = vsqrtsd %xmm1, %xmm2, %xmm3
0xc5,0xeb,0x51,0x18 = vsqrtsd 0(%eax), %xmm2, %xmm3
0xc5,0xea,0x51,0xd9 = vsqrtss %xmm1, %xmm2, %xmm3
0xc5,0xea,0x51,0x18 = vsqrtss 0(%eax), %xmm2, %xmm3
0xc5,0xf8,0x52,0xd1 = vrsqrtps %xmm1, %xmm2
0xc5,0xf8,0x52,0x10 = vrsqrtps 0(%eax), %xmm2
0xc5,0xea,0x52,0xd9 = vrsqrtss %xmm1, %xmm2, %xmm3
0xc5,0xea,0x52,0x18 = vrsqrtss 0(%eax), %xmm2, %xmm3
0xc5,0xf8,0x53,0xd1 = vrcpps %xmm1, %xmm2
0xc5,0xf8,0x53,0x10 = vrcpps 0(%eax), %xmm2
0xc5,0xea,0x53,0xd9 = vrcpss %xmm1, %xmm2, %xmm3
0xc5,0xea,0x53,0x18 = vrcpss 0(%eax), %xmm2, %xmm3
0xc5,0xf9,0xe7,0x08 = vmovntdq %xmm1, 0(%eax)
0xc5,0xf9,0x2b,0x08 = vmovntpd %xmm1, 0(%eax)
0xc5,0xf8,0x2b,0x08 = vmovntps %xmm1, 0(%eax)
0xc5,0xf8,0xae,0x10 = vldmxcsr 0(%eax)
0xc5,0xf8,0xae,0x18 = vstmxcsr 0(%eax)
...
0xc5,0xe9,0xf8,0x18 = vpsubb 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xf9,0xd9 = vpsubw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xf9,0x18 = vpsubw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xfa,0xd9 = vpsubd %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xfa,0x18 = vpsubd 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xfb,0xd9 = vpsubq %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xfb,0x18 = vpsubq 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xe8,0xd9 = vpsubsb %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xe8,0x18 = vpsubsb 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xe9,0xd9 = vpsubsw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xe9,0x18 = vpsubsw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xd8,0xd9 = vpsubusb %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xd8,0x18 = vpsubusb 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xd9,0xd9 = vpsubusw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xd9,0x18 = vpsubusw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xfc,0xd9 = vpaddb %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xfc,0x18 = vpaddb 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xfd,0xd9 = vpaddw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xfd,0x18 = vpaddw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xfe,0xd9 = vpaddd %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xfe,0x18 = vpaddd 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xd4,0xd9 = vpaddq %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xd4,0x18 = vpaddq 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xec,0xd9 = vpaddsb %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xec,0x18 = vpaddsb 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xed,0xd9 = vpaddsw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xed,0x18 = vpaddsw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xdc,0xd9 = vpaddusb %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xdc,0x18 = vpaddusb 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xdd,0xd9 = vpaddusw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xdd,0x18 = vpaddusw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xe4,0xd9 = vpmulhuw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xe4,0x18 = vpmulhuw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xe5,0xd9 = vpmulhw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xe5,0x18 = vpmulhw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xd5,0xd9 = vpmullw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xd5,0x18 = vpmullw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xf4,0xd9 = vpmuludq %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xf4,0x18 = vpmuludq 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xe0,0xd9 = vpavgb %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xe0,0x18 = vpavgb 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xe3,0xd9 = vpavgw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xe3,0x18 = vpavgw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xea,0xd9 = vpminsw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xea,0x18 = vpminsw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xda,0xd9 = vpminub %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xda,0x18 = vpminub 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xee,0xd9 = vpmaxsw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xee,0x18 = vpmaxsw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xde,0xd9 = vpmaxub %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xde,0x18 = vpmaxub 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xf6,0xd9 = vpsadbw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xf6,0x18 = vpsadbw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xf1,0xd9 = vpsllw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xf1,0x18 = vpsllw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xf2,0xd9 = vpslld %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xf2,0x18 = vpslld 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xf3,0xd9 = vpsllq %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xf3,0x18 = vpsllq 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xe1,0xd9 = vpsraw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xe1,0x18 = vpsraw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xe2,0xd9 = vpsrad %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xe2,0x18 = vpsrad 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xd1,0xd9 = vpsrlw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xd1,0x18 = vpsrlw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xd2,0xd9 = vpsrld %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xd2,0x18 = vpsrld 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xd3,0xd9 = vpsrlq %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xd3,0x18 = vpsrlq 0(%eax), %xmm2, %xmm3
...
0xc5,0xe9,0xdb,0x18 = vpand 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xeb,0xd9 = vpor %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xeb,0x18 = vpor 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xef,0xd9 = vpxor %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xef,0x18 = vpxor 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xdf,0xd9 = vpandn %xmm1, %xmm2, %xmm3
0xc5,0xe9,0xdf,0x18 = vpandn 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x74,0xd9 = vpcmpeqb %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x74,0x18 = vpcmpeqb 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x75,0xd9 = vpcmpeqw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x75,0x18 = vpcmpeqw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x76,0xd9 = vpcmpeqd %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x76,0x18 = vpcmpeqd 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x64,0xd9 = vpcmpgtb %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x64,0x18 = vpcmpgtb 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x65,0xd9 = vpcmpgtw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x65,0x18 = vpcmpgtw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x66,0xd9 = vpcmpgtd %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x66,0x18 = vpcmpgtd 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x63,0xd9 = vpacksswb %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x63,0x18 = vpacksswb 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x6b,0xd9 = vpackssdw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x6b,0x18 = vpackssdw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x67,0xd9 = vpackuswb %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x67,0x18 = vpackuswb 0(%eax), %xmm2, %xmm3
0xc5,0xf9,0x70,0xda,0x04 = vpshufd $4, %xmm2, %xmm3
0xc5,0xf9,0x70,0x18,0x04 = vpshufd $4, 0(%eax), %xmm3
0xc5,0xfa,0x70,0xda,0x04 = vpshufhw $4, %xmm2, %xmm3
0xc5,0xfa,0x70,0x18,0x04 = vpshufhw $4, 0(%eax), %xmm3
0xc5,0xfb,0x70,0xda,0x04 = vpshuflw $4, %xmm2, %xmm3
0xc5,0xfb,0x70,0x18,0x04 = vpshuflw $4, 0(%eax), %xmm3
0xc5,0xe9,0x60,0xd9 = vpunpcklbw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x60,0x18 = vpunpcklbw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x61,0xd9 = vpunpcklwd %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x61,0x18 = vpunpcklwd 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x62,0xd9 = vpunpckldq %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x62,0x18 = vpunpckldq 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x6c,0xd9 = vpunpcklqdq %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x6c,0x18 = vpunpcklqdq 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x68,0xd9 = vpunpckhbw %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x68,0x18 = vpunpckhbw 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x69,0xd9 = vpunpckhwd %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x69,0x18 = vpunpckhwd 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x6a,0xd9 = vpunpckhdq %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x6a,0x18 = vpunpckhdq 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x6d,0xd9 = vpunpckhqdq %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x6d,0x18 = vpunpckhqdq 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0xc4,0xd8,0x07 = vpinsrw $7, %eax, %xmm2, %xmm3
0xc5,0xe9,0xc4,0x18,0x07 = vpinsrw $7, 0(%eax), %xmm2, %xmm3
...
0xc5,0xf9,0x7e,0x08 = vmovd %xmm1, 0(%eax)
0xc5,0xf9,0x6e,0xc8 = vmovd %eax, %xmm1
0xc5,0xf9,0x6e,0x08 = vmovd 0(%eax), %xmm1
0xc5,0xf9,0xd6,0x08 = vmovq %xmm1, 0(%eax)
0xc5,0xfa,0x7e,0xd1 = vmovq %xmm1, %xmm2
0xc5,0xfa,0x7e,0x08 = vmovq 0(%eax), %xmm1
0xc5,0xfb,0xe6,0xd1 = vcvtpd2dq %xmm1, %xmm2
0xc5,0xfa,0xe6,0xd1 = vcvtdq2pd %xmm1, %xmm2
0xc5,0xfa,0xe6,0x10 = vcvtdq2pd 0(%eax), %xmm2
0xc5,0xfa,0x16,0xd1 = vmovshdup %xmm1, %xmm2
0xc5,0xfa,0x16,0x10 = vmovshdup 0(%eax), %xmm2
0xc5,0xfa,0x12,0xd1 = vmovsldup %xmm1, %xmm2
0xc5,0xfa,0x12,0x10 = vmovsldup 0(%eax), %xmm2
0xc5,0xfb,0x12,0xd1 = vmovddup %xmm1, %xmm2
0xc5,0xfb,0x12,0x10 = vmovddup 0(%eax), %xmm2
0xc5,0xeb,0xd0,0xd9 = vaddsubps %xmm1, %xmm2, %xmm3
0xc5,0xf3,0xd0,0x10 = vaddsubps 0(%eax), %xmm1, %xmm2
0xc5,0xe9,0xd0,0xd9 = vaddsubpd %xmm1, %xmm2, %xmm3
0xc5,0xf1,0xd0,0x10 = vaddsubpd 0(%eax), %xmm1, %xmm2
0xc5,0xeb,0x7c,0xd9 = vhaddps %xmm1, %xmm2, %xmm3
0xc5,0xeb,0x7c,0x18 = vhaddps 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x7c,0xd9 = vhaddpd %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x7c,0x18 = vhaddpd 0(%eax), %xmm2, %xmm3
0xc5,0xeb,0x7d,0xd9 = vhsubps %xmm1, %xmm2, %xmm3
0xc5,0xeb,0x7d,0x18 = vhsubps 0(%eax), %xmm2, %xmm3
0xc5,0xe9,0x7d,0xd9 = vhsubpd %xmm1, %xmm2, %xmm3
0xc5,0xe9,0x7d,0x18 = vhsubpd 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x79,0x1c,0xd1 = vpabsb %xmm1, %xmm2
0xc4,0xe2,0x79,0x1c,0x10 = vpabsb 0(%eax), %xmm2
0xc4,0xe2,0x79,0x1d,0xd1 = vpabsw %xmm1, %xmm2
0xc4,0xe2,0x79,0x1d,0x10 = vpabsw 0(%eax), %xmm2
0xc4,0xe2,0x79,0x1e,0xd1 = vpabsd %xmm1, %xmm2
0xc4,0xe2,0x79,0x1e,0x10 = vpabsd 0(%eax), %xmm2
0xc4,0xe2,0x69,0x01,0xd9 = vphaddw %xmm1, %xmm2, %xmm3
0xc4,0xe2,0x69,0x01,0x18 = vphaddw 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x69,0x02,0xd9 = vphaddd %xmm1, %xmm2, %xmm3
0xc4,0xe2,0x69,0x02,0x18 = vphaddd 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x69,0x03,0xd9 = vphaddsw %xmm1, %xmm2, %xmm3
0xc4,0xe2,0x69,0x03,0x18 = vphaddsw 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x69,0x05,0xd9 = vphsubw %xmm1, %xmm2, %xmm3
0xc4,0xe2,0x69,0x05,0x18 = vphsubw 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x69,0x06,0xd9 = vphsubd %xmm1, %xmm2, %xmm3
0xc4,0xe2,0x69,0x06,0x18 = vphsubd 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x69,0x07,0xd9 = vphsubsw %xmm1, %xmm2, %xmm3
0xc4,0xe2,0x69,0x07,0x18 = vphsubsw 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x69,0x04,0xd9 = vpmaddubsw %xmm1, %xmm2, %xmm3
0xc4,0xe2,0x69,0x04,0x18 = vpmaddubsw 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x69,0x00,0xd9 = vpshufb %xmm1, %xmm2, %xmm3
0xc4,0xe2,0x69,0x00,0x18 = vpshufb 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x69,0x08,0xd9 = vpsignb %xmm1, %xmm2, %xmm3
0xc4,0xe2,0x69,0x08,0x18 = vpsignb 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x69,0x09,0xd9 = vpsignw %xmm1, %xmm2, %xmm3
0xc4,0xe2,0x69,0x09,0x18 = vpsignw 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x69,0x0a,0xd9 = vpsignd %xmm1, %xmm2, %xmm3
0xc4,0xe2,0x69,0x0a,0x18 = vpsignd 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x69,0x0b,0xd9 = vpmulhrsw %xmm1, %xmm2, %xmm3
0xc4,0xe2,0x69,0x0b,0x18 = vpmulhrsw 0(%eax), %xmm2, %xmm3
0xc4,0xe3,0x69,0x0f,0xd9,0x07 = vpalignr $7, %xmm1, %xmm2, %xmm3
0xc4,0xe3,0x69,0x0f,0x18,0x07 = vpalignr $7, 0(%eax), %xmm2, %xmm3
0xc4,0xe3,0x69,0x0b,0xd9,0x07 = vroundsd $7, %xmm1, %xmm2, %xmm3
0xc4,0xe3,0x69,0x0b,0x18,0x07 = vroundsd $7, 0(%eax), %xmm2, %xmm3
0xc4,0xe3,0x69,0x0a,0xd9,0x07 = vroundss $7, %xmm1, %xmm2, %xmm3
0xc4,0xe3,0x69,0x0a,0x18,0x07 = vroundss $7, 0(%eax), %xmm2, %xmm3
0xc4,0xe3,0x79,0x09,0xda,0x07 = vroundpd $7, %xmm2, %xmm3
0xc4,0xe3,0x79,0x09,0x18,0x07 = vroundpd $7, 0(%eax), %xmm3
0xc4,0xe3,0x79,0x08,0xda,0x07 = vroundps $7, %xmm2, %xmm3
0xc4,0xe3,0x79,0x08,0x18,0x07 = vroundps $7, 0(%eax), %xmm3
0xc4,0xe2,0x79,0x41,0xda = vphminposuw %xmm2, %xmm3
0xc4,0xe2,0x79,0x41,0x10 = vphminposuw 0(%eax), %xmm2
0xc4,0xe2,0x61,0x2b,0xca = vpackusdw %xmm2, %xmm3, %xmm1
0xc4,0xe2,0x69,0x2b,0x18 = vpackusdw 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x61,0x29,0xca = vpcmpeqq %xmm2, %xmm3, %xmm1
0xc4,0xe2,0x69,0x29,0x18 = vpcmpeqq 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x61,0x38,0xca = vpminsb %xmm2, %xmm3, %xmm1
0xc4,0xe2,0x69,0x38,0x18 = vpminsb 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x61,0x39,0xca = vpminsd %xmm2, %xmm3, %xmm1
0xc4,0xe2,0x69,0x39,0x18 = vpminsd 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x61,0x3b,0xca = vpminud %xmm2, %xmm3, %xmm1
0xc4,0xe2,0x69,0x3b,0x18 = vpminud 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x61,0x3a,0xca = vpminuw %xmm2, %xmm3, %xmm1
0xc4,0xe2,0x69,0x3a,0x18 = vpminuw 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x61,0x3c,0xca = vpmaxsb %xmm2, %xmm3, %xmm1
0xc4,0xe2,0x69,0x3c,0x18 = vpmaxsb 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x61,0x3d,0xca = vpmaxsd %xmm2, %xmm3, %xmm1
0xc4,0xe2,0x69,0x3d,0x18 = vpmaxsd 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x61,0x3f,0xca = vpmaxud %xmm2, %xmm3, %xmm1
0xc4,0xe2,0x69,0x3f,0x18 = vpmaxud 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x61,0x3e,0xca = vpmaxuw %xmm2, %xmm3, %xmm1
0xc4,0xe2,0x69,0x3e,0x18 = vpmaxuw 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x61,0x28,0xca = vpmuldq %xmm2, %xmm3, %xmm1
0xc4,0xe2,0x69,0x28,0x18 = vpmuldq 0(%eax), %xmm2, %xmm3
0xc4,0xe2,0x51,0x40,0xca = vpmulld %xmm2, %xmm5, %xmm1
0xc4,0xe2,0x51,0x40,0x18 = vpmulld 0(%eax), %xmm5, %xmm3
0xc4,0xe3,0x51,0x0c,0xca,0x03 = vblendps $3, %xmm2, %xmm5, %xmm1
0xc4,0xe3,0x51,0x0c,0x08,0x03 = vblendps $3, 0(%eax), %xmm5, %xmm1
0xc4,0xe3,0x51,0x0d,0xca,0x03 = vblendpd $3, %xmm2, %xmm5, %xmm1
0xc4,0xe3,0x51,0x0d,0x08,0x03 = vblendpd $3, 0(%eax), %xmm5, %xmm1
0xc4,0xe3,0x51,0x0e,0xca,0x03 = vpblendw $3, %xmm2, %xmm5, %xmm1
0xc4,0xe3,0x51,0x0e,0x08,0x03 = vpblendw $3, 0(%eax), %xmm5, %xmm1
0xc4,0xe3,0x51,0x42,0xca,0x03 = vmpsadbw $3, %xmm2, %xmm5, %xmm1
0xc4,0xe3,0x51,0x42,0x08,0x03 = vmpsadbw $3, 0(%eax), %xmm5, %xmm1
0xc4,0xe3,0x51,0x40,0xca,0x03 = vdpps $3, %xmm2, %xmm5, %xmm1
0xc4,0xe3,0x51,0x40,0x08,0x03 = vdpps $3, 0(%eax), %xmm5, %xmm1
0xc4,0xe3,0x51,0x41,0xca,0x03 = vdppd $3, %xmm2, %xmm5, %xmm1
0xc4,0xe3,0x51,0x41,0x08,0x03 = vdppd $3, 0(%eax), %xmm5, %xmm1
0xc4,0xe3,0x71,0x4b,0xdd,0x20 = vblendvpd %xmm2, %xmm5, %xmm1, %xmm3
0xc4,0xe3,0x71,0x4b,0x18,0x20 = vblendvpd %xmm2, 0(%eax), %xmm1, %xmm3
0xc4,0xe3,0x71,0x4a,0xdd,0x20 = vblendvps %xmm2, %xmm5, %xmm1, %xmm3
0xc4,0xe3,0x71,0x4a,0x18,0x20 = vblendvps %xmm2, 0(%eax), %xmm1, %xmm3
0xc4,0xe3,0x71,0x4c,0xdd,0x20 = vpblendvb %xmm2, %xmm5, %xmm1, %xmm3
0xc4,0xe3,0x71,0x4c,0x18,0x20 = vpblendvb %xmm2, 0(%eax), %xmm1, %xmm3
0xc4,0xe2,0x79,0x20,0xea = vpmovsxbw %xmm2, %xmm5
0xc4,0xe2,0x79,0x20,0x10 = vpmovsxbw 0(%eax), %xmm2
0xc4,0xe2,0x79,0x23,0xea = vpmovsxwd %xmm2, %xmm5
0xc4,0xe2,0x79,0x23,0x10 = vpmovsxwd 0(%eax), %xmm2
0xc4,0xe2,0x79,0x25,0xea = vpmovsxdq %xmm2, %xmm5
0xc4,0xe2,0x79,0x25,0x10 = vpmovsxdq 0(%eax), %xmm2
0xc4,0xe2,0x79,0x30,0xea = vpmovzxbw %xmm2, %xmm5
0xc4,0xe2,0x79,0x30,0x10 = vpmovzxbw 0(%eax), %xmm2
0xc4,0xe2,0x79,0x33,0xea = vpmovzxwd %xmm2, %xmm5
0xc4,0xe2,0x79,0x33,0x10 = vpmovzxwd 0(%eax), %xmm2
0xc4,0xe2,0x79,0x35,0xea = vpmovzxdq %xmm2, %xmm5
0xc4,0xe2,0x79,0x35,0x10 = vpmovzxdq 0(%eax), %xmm2
0xc4,0xe2,0x79,0x22,0xea = vpmovsxbq %xmm2, %xmm5
0xc4,0xe2,0x79,0x22,0x10 = vpmovsxbq 0(%eax), %xmm2
0xc4,0xe2,0x79,0x32,0xea = vpmovzxbq %xmm2, %xmm5
0xc4,0xe2,0x79,0x32,0x10 = vpmovzxbq 0(%eax), %xmm2
0xc4,0xe2,0x79,0x21,0xea = vpmovsxbd %xmm2, %xmm5
0xc4,0xe2,0x79,0x21,0x10 = vpmovsxbd 0(%eax), %xmm2
0xc4,0xe2,0x79,0x24,0xea = vpmovsxwq %xmm2, %xmm5
0xc4,0xe2,0x79,0x24,0x10 = vpmovsxwq 0(%eax), %xmm2
0xc4,0xe2,0x79,0x31,0xea = vpmovzxbd %xmm2, %xmm5
0xc4,0xe2,0x79,0x31,0x10 = vpmovzxbd 0(%eax), %xmm2
0xc4,0xe2,0x79,0x34,0xea = vpmovzxwq %xmm2, %xmm5
0xc4,0xe2,0x79,0x34,0x10 = vpmovzxwq 0(%eax), %xmm2
0xc5,0xf9,0xc5,0xc2,0x07 = vpextrw $7, %xmm2, %eax
0xc4,0xe3,0x79,0x15,0x10,0x07 = vpextrw $7, %xmm2, 0(%eax)
0xc4,0xe3,0x79,0x16,0xd0,0x07 = vpextrd $7, %xmm2, %eax
0xc4,0xe3,0x79,0x16,0x10,0x07 = vpextrd $7, %xmm2, 0(%eax)
0xc4,0xe3,0x79,0x14,0xd0,0x07 = vpextrb $7, %xmm2, %eax
0xc4,0xe3,0x79,0x14,0x10,0x07 = vpextrb $7, %xmm2, 0(%eax)
0xc4,0xe3,0x79,0x17,0x10,0x07 = vextractps $7, %xmm2, 0(%eax)
0xc4,0xe3,0x79,0x17,0xd0,0x07 = vextractps $7, %xmm2, %eax
0xc5,0xe9,0xc4,0xe8,0x07 = vpinsrw $7, %eax, %xmm2, %xmm5
0xc5,0xe9,0xc4,0x28,0x07 = vpinsrw $7, 0(%eax), %xmm2, %xmm5
0xc4,0xe3,0x69,0x20,0xe8,0x07 = vpinsrb $7, %eax, %xmm2, %xmm5
0xc4,0xe3,0x69,0x20,0x28,0x07 = vpinsrb $7, 0(%eax), %xmm2, %xmm5
0xc4,0xe3,0x69,0x22,0xe8,0x07 = vpinsrd $7, %eax, %xmm2, %xmm5
0xc4,0xe3,0x69,0x22,0x28,0x07 = vpinsrd $7, 0(%eax), %xmm2, %xmm5
0xc4,0xe3,0x51,0x21,0xca,0x07 = vinsertps $7, %xmm2, %xmm5, %xmm1
0xc4,0xe3,0x51,0x21,0x08,0x07 = vinsertps $7, 0(%eax), %xmm5, %xmm1
0xc4,0xe2,0x79,0x17,0xea = vptest %xmm2, %xmm5
0xc4,0xe2,0x79,0x17,0x10 = vptest 0(%eax), %xmm2
0xc4,0xe2,0x79,0x2a,0x10 = vmovntdqa 0(%eax), %xmm2
0xc4,0xe2,0x51,0x37,0xca = vpcmpgtq %xmm2, %xmm5, %xmm1
0xc4,0xe2,0x51,0x37,0x18 = vpcmpgtq 0(%eax), %xmm5, %xmm3
0xc4,0xe3,0x79,0x62,0xea,0x07 = vpcmpistrm $7, %xmm2, %xmm5
0xc4,0xe3,0x79,0x62,0x28,0x07 = vpcmpistrm $7, 0(%eax), %xmm5
0xc4,0xe3,0x79,0x60,0xea,0x07 = vpcmpestrm $7, %xmm2, %xmm5
0xc4,0xe3,0x79,0x60,0x28,0x07 = vpcmpestrm $7, 0(%eax), %xmm5
0xc4,0xe3,0x79,0x63,0xea,0x07 = vpcmpistri $7, %xmm2, %xmm5
0xc4,0xe3,0x79,0x63,0x28,0x07 = vpcmpistri $7, 0(%eax), %xmm5
0xc4,0xe3,0x79,0x61,0xea,0x07 = vpcmpestri $7, %xmm2, %xmm5
0xc4,0xe3,0x79,0x61,0x28,0x07 = vpcmpestri $7, 0(%eax), %xmm5
0xc4,0xe2,0x79,0xdb,0xea = vaesimc %xmm2, %xmm5
0xc4,0xe2,0x79,0xdb,0x10 = vaesimc 0(%eax), %xmm2
0xc4,0xe2,0x51,0xdc,0xca = vaesenc %xmm2, %xmm5, %xmm1
0xc4,0xe2,0x51,0xdc,0x18 = vaesenc 0(%eax), %xmm5, %xmm3
0xc4,0xe2,0x51,0xdd,0xca = vaesenclast %xmm2, %xmm5, %xmm1
0xc4,0xe2,0x51,0xdd,0x18 = vaesenclast 0(%eax), %xmm5, %xmm3
0xc4,0xe2,0x51,0xde,0xca = vaesdec %xmm2, %xmm5, %xmm1
0xc4,0xe2,0x51,0xde,0x18 = vaesdec 0(%eax), %xmm5, %xmm3
0xc4,0xe2,0x51,0xdf,0xca = vaesdeclast %xmm2, %xmm5, %xmm1
0xc4,0xe2,0x51,0xdf,0x18 = vaesdeclast 0(%eax), %xmm5, %xmm3
0xc4,0xe3,0x79,0xdf,0xea,0x07 = vaeskeygenassist $7, %xmm2, %xmm5
0xc4,0xe3,0x79,0xdf,0x28,0x07 = vaeskeygenassist $7, 0(%eax), %xmm5
...
0xc5,0xfc,0x28,0x10 = vmovaps 0(%eax), %ymm2
0xc5,0xfc,0x28,0xd1 = vmovaps %ymm1, %ymm2
0xc5,0xfc,0x29,0x08 = vmovaps %ymm1, 0(%eax)
0xc5,0xfd,0x28,0x10 = vmovapd 0(%eax), %ymm2
0xc5,0xfd,0x28,0xd1 = vmovapd %ymm1, %ymm2
0xc5,0xfd,0x29,0x08 = vmovapd %ymm1, 0(%eax)
0xc5,0xfc,0x10,0x10 = vmovups 0(%eax), %ymm2
0xc5,0xfc,0x10,0xd1 = vmovups %ymm1, %ymm2
0xc5,0xfc,0x11,0x08 = vmovups %ymm1, 0(%eax)
0xc5,0xfd,0x10,0x10 = vmovupd 0(%eax), %ymm2
0xc5,0xfd,0x10,0xd1 = vmovupd %ymm1, %ymm2
0xc5,0xfd,0x11,0x08 = vmovupd %ymm1, 0(%eax)
...
0xc5,0xfd,0xe7,0x08 = vmovntdq %ymm1, 0(%eax)
0xc5,0xfd,0x2b,0x08 = vmovntpd %ymm1, 0(%eax)
0xc5,0xfc,0x2b,0x08 = vmovntps %ymm1, 0(%eax)
0xc5,0xf8,0x50,0xc2 = vmovmskps %xmm2, %eax
0xc5,0xf9,0x50,0xc2 = vmovmskpd %xmm2, %eax
...
0xc5,0xdc,0x5f,0x30 = vmaxps 0(%eax), %ymm4, %ymm6
0xc5,0xdd,0x5f,0x30 = vmaxpd 0(%eax), %ymm4, %ymm6
0xc5,0xdc,0x5d,0x30 = vminps 0(%eax), %ymm4, %ymm6
0xc5,0xdd,0x5d,0x30 = vminpd 0(%eax), %ymm4, %ymm6
0xc5,0xdc,0x5c,0x30 = vsubps 0(%eax), %ymm4, %ymm6
0xc5,0xdd,0x5c,0x30 = vsubpd 0(%eax), %ymm4, %ymm6
0xc5,0xdc,0x5e,0x30 = vdivps 0(%eax), %ymm4, %ymm6
0xc5,0xdd,0x5e,0x30 = vdivpd 0(%eax), %ymm4, %ymm6
0xc5,0xdc,0x58,0x30 = vaddps 0(%eax), %ymm4, %ymm6
0xc5,0xdd,0x58,0x30 = vaddpd 0(%eax), %ymm4, %ymm6
0xc5,0xdc,0x59,0x30 = vmulps 0(%eax), %ymm4, %ymm6
0xc5,0xdd,0x59,0x30 = vmulpd 0(%eax), %ymm4, %ymm6
0xc5,0xfd,0x51,0xd1 = vsqrtpd %ymm1, %ymm2
0xc5,0xfd,0x51,0x10 = vsqrtpd 0(%eax), %ymm2
0xc5,0xfc,0x51,0xd1 = vsqrtps %ymm1, %ymm2
0xc5,0xfc,0x51,0x10 = vsqrtps 0(%eax), %ymm2
0xc5,0xfc,0x52,0xd1 = vrsqrtps %ymm1, %ymm2
0xc5,0xfc,0x52,0x10 = vrsqrtps 0(%eax), %ymm2
0xc5,0xfc,0x53,0xd1 = vrcpps %ymm1, %ymm2
0xc5,0xfc,0x53,0x10 = vrcpps 0(%eax), %ymm2
...
0xc5,0xfc,0x5a,0x10 = vcvtps2pd 0(%eax), %ymm2
0xc5,0xfe,0xe6,0xd3 = vcvtdq2pd %xmm3, %ymm2
0xc5,0xfe,0xe6,0x10 = vcvtdq2pd 0(%eax), %ymm2
0xc5,0xfc,0x5b,0xea = vcvtdq2ps %ymm2, %ymm5
0xc5,0xfc,0x5b,0x10 = vcvtdq2ps 0(%eax), %ymm2
0xc5,0xfd,0x5b,0xea = vcvtps2dq %ymm2, %ymm5
0xc5,0xfd,0x5b,0x28 = vcvtps2dq 0(%eax), %ymm5
0xc5,0xfe,0x5b,0xea = vcvttps2dq %ymm2, %ymm5
0xc5,0xfe,0x5b,0x28 = vcvttps2dq 0(%eax), %ymm5
...
0xc5,0xf7,0xd0,0x10 = vaddsubps 0(%eax), %ymm1, %ymm2
0xc5,0xed,0xd0,0xd9 = vaddsubpd %ymm1, %ymm2, %ymm3
0xc5,0xf5,0xd0,0x10 = vaddsubpd 0(%eax), %ymm1, %ymm2
0xc5,0xef,0x7c,0xd9 = vhaddps %ymm1, %ymm2, %ymm3
0xc5,0xef,0x7c,0x18 = vhaddps 0(%eax), %ymm2, %ymm3
0xc5,0xed,0x7c,0xd9 = vhaddpd %ymm1, %ymm2, %ymm3
0xc5,0xed,0x7c,0x18 = vhaddpd 0(%eax), %ymm2, %ymm3
0xc5,0xef,0x7d,0xd9 = vhsubps %ymm1, %ymm2, %ymm3
0xc5,0xef,0x7d,0x18 = vhsubps 0(%eax), %ymm2, %ymm3
0xc5,0xed,0x7d,0xd9 = vhsubpd %ymm1, %ymm2, %ymm3
0xc5,0xed,0x7d,0x18 = vhsubpd 0(%eax), %ymm2, %ymm3
0xc4,0xe3,0x55,0x0c,0xca,0x03 = vblendps $3, %ymm2, %ymm5, %ymm1
0xc4,0xe3,0x55,0x0c,0x08,0x03 = vblendps $3, 0(%eax), %ymm5, %ymm1
0xc4,0xe3,0x55,0x0d,0xca,0x03 = vblendpd $3, %ymm2, %ymm5, %ymm1
0xc4,0xe3,0x55,0x0d,0x08,0x03 = vblendpd $3, 0(%eax), %ymm5, %ymm1
0xc4,0xe3,0x55,0x40,0xca,0x03 = vdpps $3, %ymm2, %ymm5, %ymm1
0xc4,0xe3,0x55,0x40,0x08,0x03 = vdpps $3, 0(%eax), %ymm5, %ymm1
0xc4,0xe2,0x7d,0x1a,0x10 = vbroadcastf128 0(%eax), %ymm2
0xc4,0xe2,0x7d,0x19,0x10 = vbroadcastsd 0(%eax), %ymm2
0xc4,0xe2,0x79,0x18,0x10 = vbroadcastss 0(%eax), %xmm2
0xc4,0xe2,0x7d,0x18,0x10 = vbroadcastss 0(%eax), %ymm2
0xc4,0xe3,0x6d,0x18,0xea,0x07 = vinsertf128 $7, %xmm2, %ymm2, %ymm5
0xc4,0xe3,0x6d,0x18,0x28,0x07 = vinsertf128 $7, 0(%eax), %ymm2, %ymm5
0xc4,0xe3,0x7d,0x19,0xd2,0x07 = vextractf128 $7, %ymm2, %xmm2
0xc4,0xe3,0x7d,0x19,0x10,0x07 = vextractf128 $7, %ymm2, 0(%eax)
0xc4,0xe2,0x51,0x2f,0x10 = vmaskmovpd %xmm2, %xmm5, 0(%eax)
0xc4,0xe2,0x55,0x2f,0x10 = vmaskmovpd %ymm2, %ymm5, 0(%eax)
0xc4,0xe2,0x69,0x2d,0x28 = vmaskmovpd 0(%eax), %xmm2, %xmm5
0xc4,0xe2,0x6d,0x2d,0x28 = vmaskmovpd 0(%eax), %ymm2, %ymm5
0xc4,0xe2,0x51,0x2e,0x10 = vmaskmovps %xmm2, %xmm5, 0(%eax)
0xc4,0xe2,0x55,0x2e,0x10 = vmaskmovps %ymm2, %ymm5, 0(%eax)
0xc4,0xe2,0x69,0x2c,0x28 = vmaskmovps 0(%eax), %xmm2, %xmm5
0xc4,0xe2,0x6d,0x2c,0x28 = vmaskmovps 0(%eax), %ymm2, %ymm5
0xc4,0xe3,0x79,0x04,0xe9,0x07 = vpermilps $7, %xmm1, %xmm5
0xc4,0xe3,0x7d,0x04,0xcd,0x07 = vpermilps $7, %ymm5, %ymm1
0xc4,0xe3,0x79,0x04,0x28,0x07 = vpermilps $7, 0(%eax), %xmm5
0xc4,0xe3,0x7d,0x04,0x28,0x07 = vpermilps $7, 0(%eax), %ymm5
0xc4,0xe2,0x51,0x0c,0xc9 = vpermilps %xmm1, %xmm5, %xmm1
0xc4,0xe2,0x55,0x0c,0xc9 = vpermilps %ymm1, %ymm5, %ymm1
0xc4,0xe2,0x51,0x0c,0x18 = vpermilps 0(%eax), %xmm5, %xmm3
0xc4,0xe2,0x55,0x0c,0x08 = vpermilps 0(%eax), %ymm5, %ymm1
0xc4,0xe3,0x79,0x05,0xe9,0x07 = vpermilpd $7, %xmm1, %xmm5
0xc4,0xe3,0x7d,0x05,0xcd,0x07 = vpermilpd $7, %ymm5, %ymm1
0xc4,0xe3,0x79,0x05,0x28,0x07 = vpermilpd $7, 0(%eax), %xmm5
0xc4,0xe3,0x7d,0x05,0x28,0x07 = vpermilpd $7, 0(%eax), %ymm5
0xc4,0xe2,0x51,0x0d,0xc9 = vpermilpd %xmm1, %xmm5, %xmm1
0xc4,0xe2,0x55,0x0d,0xc9 = vpermilpd %ymm1, %ymm5, %ymm1
0xc4,0xe2,0x51,0x0d,0x18 = vpermilpd 0(%eax), %xmm5, %xmm3
0xc4,0xe2,0x55,0x0d,0x08 = vpermilpd 0(%eax), %ymm5, %ymm1
0xc4,0xe3,0x55,0x06,0xca,0x07 = vperm2f128 $7, %ymm2, %ymm5, %ymm1
0xc4,0xe3,0x55,0x06,0x08,0x07 = vperm2f128 $7, 0(%eax), %ymm5, %ymm1
0xc5,0xfc,0x77 = vzeroall 
0xc5,0xf8,0x77 = vzeroupper 
0xc5,0xfb,0x2d,0xcc = vcvtsd2si %xmm4, %ecx
0xc5,0xfb,0x2d,0x09 = vcvtsd2si 0(%ecx), %ecx
0xc5,0xfb,0x2d,0xcc = vcvtsd2si %xmm4, %ecx
0xc5,0xfb,0x2d,0x09 = vcvtsd2si 0(%ecx), %ecx
0xc5,0xfb,0x2a,0x7d,0x00 = vcvtsi2sdl 0(%ebp), %xmm0, %xmm7
0xc5,0xfb,0x2a,0x3c,0x24 = vcvtsi2sdl 0(%esp), %xmm0, %xmm7
0xc5,0xfb,0x2a,0x7d,0x00 = vcvtsi2sdl 0(%ebp), %xmm0, %xmm7
0xc5,0xfb,0x2a,0x3c,0x24 = vcvtsi2sdl 0(%esp), %xmm0, %xmm7
0xc5,0xff,0xf0,0x10 = vlddqu 0(%eax), %ymm2
0xc5,0xff,0x12,0xea = vmovddup %ymm2, %ymm5
0xc5,0xff,0x12,0x10 = vmovddup 0(%eax), %ymm2
0xc5,0xfd,0x6f,0xea = vmovdqa %ymm2, %ymm5
0xc5,0xfd,0x7f,0x10 = vmovdqa %ymm2, 0(%eax)
0xc5,0xfd,0x6f,0x10 = vmovdqa 0(%eax), %ymm2
0xc5,0xfe,0x6f,0xea = vmovdqu %ymm2, %ymm5
0xc5,0xfe,0x7f,0x10 = vmovdqu %ymm2, 0(%eax)
0xc5,0xfe,0x6f,0x10 = vmovdqu 0(%eax), %ymm2
0xc5,0xfe,0x16,0xea = vmovshdup %ymm2, %ymm5
0xc5,0xfe,0x16,0x10 = vmovshdup 0(%eax), %ymm2
0xc5,0xfe,0x12,0xea = vmovsldup %ymm2, %ymm5
0xc5,0xfe,0x12,0x10 = vmovsldup 0(%eax), %ymm2
0xc4,0xe2,0x7d,0x17,0xea = vptest %ymm2, %ymm5
0xc4,0xe2,0x7d,0x17,0x10 = vptest 0(%eax), %ymm2
0xc4,0xe3,0x7d,0x09,0xcd,0x07 = vroundpd $7, %ymm5, %ymm1
0xc4,0xe3,0x7d,0x09,0x28,0x07 = vroundpd $7, 0(%eax), %ymm5
0xc4,0xe3,0x7d,0x08,0xcd,0x07 = vroundps $7, %ymm5, %ymm1
0xc4,0xe3,0x7d,0x08,0x28,0x07 = vroundps $7, 0(%eax), %ymm5
0xc5,0xd5,0xc6,0xca,0x07 = vshufpd $7, %ymm2, %ymm5, %ymm1
0xc5,0xd5,0xc6,0x08,0x07 = vshufpd $7, 0(%eax), %ymm5, %ymm1
0xc5,0xd4,0xc6,0xca,0x07 = vshufps $7, %ymm2, %ymm5, %ymm1
0xc5,0xd4,0xc6,0x08,0x07 = vshufps $7, 0(%eax), %ymm5, %ymm1
0xc4,0xe2,0x79,0x0f,0xea = vtestpd %xmm2, %xmm5
0xc4,0xe2,0x7d,0x0f,0xea = vtestpd %ymm2, %ymm5
0xc4,0xe2,0x79,0x0f,0x10 = vtestpd 0(%eax), %xmm2
0xc4,0xe2,0x7d,0x0f,0x10 = vtestpd 0(%eax), %ymm2
0xc4,0xe2,0x79,0x0e,0xea = vtestps %xmm2, %xmm5
0xc4,0xe2,0x7d,0x0e,0xea = vtestps %ymm2, %ymm5
0xc4,0xe2,0x79,0x0e,0x10 = vtestps 0(%eax), %xmm2
0xc4,0xe2,0x7d,0x0e,0x10 = vtestps 0(%eax), %ymm2
...
0xc4,0xe3,0x51,0x44,0x18,0x11 = vpclmulhqhqdq 0(%eax), %xmm5, %xmm3
0xc4,0xe3,0x51,0x44,0xca,0x01 = vpclmulhqlqdq %xmm2, %xmm5, %xmm1
0xc4,0xe3,0x51,0x44,0x18,0x01 = vpclmulhqlqdq 0(%eax), %xmm5, %xmm3
0xc4,0xe3,0x51,0x44,0xca,0x10 = vpclmullqhqdq %xmm2, %xmm5, %xmm1
0xc4,0xe3,0x51,0x44,0x18,0x10 = vpclmullqhqdq 0(%eax), %xmm5, %xmm3
0xc4,0xe3,0x51,0x44,0xca,0x00 = vpclmullqlqdq %xmm2, %xmm5, %xmm1
0xc4,0xe3,0x51,0x44,0x18,0x00 = vpclmullqlqdq 0(%eax), %xmm5, %xmm3
0xc4,0xe3,0x51,0x44,0xca,0x11 = vpclmulqdq $17, %xmm2, %xmm5, %xmm1
0xc4,0xe3,0x51,0x44,0x18,0x11 = vpclmulqdq $17, 0(%eax), %xmm5, %xmm3