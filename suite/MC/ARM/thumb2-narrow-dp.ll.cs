...
0x40,0x1d = adds r0, r0, #5
0x08,0x31 = adds r1, #8
0x11,0xf1,0x08,0x01 = adds.w r1, r1, #8
0x18,0xf1,0x08,0x08 = adds.w r8, r8, #8
0x08,0xbf = it eq
0x40,0x1d = addeq r0, r0, #5
0x08,0xbf = it eq
0x08,0x31 = addeq r1, #8
0x08,0xbf = it eq
0x10,0xf1,0x05,0x00 = addseq.w r0, r0, #5
0x08,0xbf = it eq
0x11,0xf1,0x08,0x01 = addseq.w r1, r1, #8
0x50,0x18 = adds r0, r2, r1
0x52,0x18 = adds r2, r2, r1
0x0b,0x44 = add r3, r1
0x08,0xbf = it eq
0x50,0x18 = addeq r0, r2, r1
0x08,0xbf = it eq
0x52,0x18 = addeq r2, r2, r1
0x08,0xbf = it eq
0x12,0xeb,0x01,0x00 = addseq.w r0, r2, r1
0x08,0xbf = it eq
0x12,0xeb,0x01,0x02 = addseq.w r2, r2, r1
0x0b,0x44 = add r3, r1
0x7c,0x44 = add r4, pc
0x7c,0x44 = add r4, pc
0x97,0x44 = add pc, r2
0x97,0x44 = add pc, r2
0xef,0x44 = add pc, sp, pc
0x05,0xb0 = add sp, #0x14
0x7f,0xb0 = add sp, #0x1fc
0x0d,0xf5,0x00,0x7d = add.w sp, sp, #0x200
0xe9,0x44 = add r9, sp, r9
0xd5,0x44 = add sp, r10
0xd5,0x44 = add sp, r10
0xfd,0x44 = add sp, pc
