...
0x83,0x00,0x10,0x91 = add	x3, x4, #1024
0x83,0x00,0x50,0x11 = add	w3, w4, #1024, lsl #12          // =4194304
0x83,0x00,0x50,0x11 = add	w3, w4, #1024, lsl #12          // =4194304
0x83,0x00,0x40,0x11 = add	w3, w4, #0, lsl #12             // =0
0x83,0x00,0x50,0x91 = add	x3, x4, #1024, lsl #12          // =4194304
0x83,0x00,0x50,0x91 = add	x3, x4, #1024, lsl #12          // =4194304
0x83,0x00,0x40,0x91 = add	x3, x4, #0, lsl #12             // =0
0xff,0x83,0x00,0x91 = add	sp, sp, #32
0x83,0x00,0x10,0x31 = adds	w3, w4, #1024
0x83,0x00,0x10,0x31 = adds	w3, w4, #1024
0x83,0x00,0x50,0x31 = adds	w3, w4, #1024, lsl #12          // =4194304
0x83,0x00,0x10,0xb1 = adds	x3, x4, #1024
0x83,0x00,0x10,0xb1 = adds	x3, x4, #1024
0x83,0x00,0x50,0xb1 = adds	x3, x4, #1024, lsl #12          // =4194304
0x83,0x00,0x10,0x51 = sub	w3, w4, #1024
0x83,0x00,0x10,0x51 = sub	w3, w4, #1024
0x83,0x00,0x50,0x51 = sub	w3, w4, #1024, lsl #12          // =4194304
0x83,0x00,0x10,0xd1 = sub	x3, x4, #1024
0x83,0x00,0x10,0xd1 = sub	x3, x4, #1024
0x83,0x00,0x50,0xd1 = sub	x3, x4, #1024, lsl #12          // =4194304
0xff,0x83,0x00,0xd1 = sub	sp, sp, #32
0x83,0x00,0x10,0x71 = subs	w3, w4, #1024
0x83,0x00,0x10,0x71 = subs	w3, w4, #1024
0x83,0x00,0x50,0x71 = subs	w3, w4, #1024, lsl #12          // =4194304
0x83,0x00,0x10,0xf1 = subs	x3, x4, #1024
0x83,0x00,0x10,0xf1 = subs	x3, x4, #1024
0x83,0x00,0x50,0xf1 = subs	x3, x4, #1024, lsl #12          // =4194304
...
0x20,0x00,0x80,0x52 = mov	w0, #1                          // =0x1
0x20,0x00,0x80,0xd2 = mov	x0, #1                          // =0x1
0x20,0x00,0xa0,0x52 = mov	w0, #65536                      // =0x10000
0x20,0x00,0xa0,0xd2 = mov	x0, #65536                      // =0x10000
0x40,0x00,0x80,0x12 = mov	w0, #-3                         // =0xfffffffd
0x40,0x00,0x80,0x92 = mov	x0, #-3                         // =0xfffffffffffffffd
0x40,0x00,0xa0,0x12 = mov	w0, #-131073                    // =0xfffdffff
0x40,0x00,0xa0,0x92 = mov	x0, #-131073                    // =0xfffffffffffdffff
