...
0x01,0x04,0x00,0x0f = movi	v1.2s, #0
0x2f,0x24,0x00,0x0f = movi	v15.2s, #1, lsl #8
0x30,0x44,0x00,0x0f = movi	v16.2s, #1, lsl #16
0x3f,0x64,0x00,0x0f = movi	v31.2s, #1, lsl #24
...
0x01,0x04,0x00,0x2f = mvni	v1.2s, #0
...
0x2f,0x24,0x00,0x6f = mvni	v15.4s, #1, lsl #8
0x30,0x44,0x00,0x6f = mvni	v16.4s, #1, lsl #16
0x3f,0x64,0x00,0x6f = mvni	v31.4s, #1, lsl #24
...
0x01,0x14,0x00,0x2f = bic	v1.2s, #0
...
0x2f,0x94,0x00,0x2f = bic	v15.4h, #1
0x30,0xb4,0x00,0x2f = bic	v16.4h, #1, lsl #8
0x20,0x94,0x00,0x6f = bic	v0.8h, #1
0x3f,0xb4,0x00,0x6f = bic	v31.8h, #1, lsl #8
0x20,0x14,0x00,0x0f = orr	v0.2s, #1
0x01,0x14,0x00,0x0f = orr	v1.2s, #0
...
0x3f,0x94,0x00,0x0f = orr	v31.4h, #1
0x2f,0xb4,0x00,0x0f = orr	v15.4h, #1, lsl #8
0x20,0x94,0x00,0x4f = orr	v0.8h, #1
0x30,0xb4,0x00,0x4f = orr	v16.8h, #1, lsl #8
0x20,0xc4,0x00,0x0f = movi	v0.2s, #1, msl #8
0x21,0xd4,0x00,0x0f = movi	v1.2s, #1, msl #16
0x20,0xc4,0x00,0x4f = movi	v0.4s, #1, msl #8
0x3f,0xd4,0x00,0x4f = movi	v31.4s, #1, msl #16
0x21,0xc4,0x00,0x2f = mvni	v1.2s, #1, msl #8
0x20,0xd4,0x00,0x2f = mvni	v0.2s, #1, msl #16
0x3f,0xc4,0x00,0x6f = mvni	v31.4s, #1, msl #8
0x20,0xd4,0x00,0x6f = mvni	v0.4s, #1, msl #16
0x00,0xe4,0x00,0x0f = movi	v0.8b, #0
0xff,0xe7,0x07,0x0f = movi	v31.8b, #255
0xef,0xe5,0x00,0x4f = movi	v15.16b, #15
