...
0xbe,0x07,0x40,0x11 = add	w30, w29, #1, lsl #12           // =4096
0xad,0xfc,0x7f,0x11 = add	w13, w5, #4095, lsl #12         // =16773120
...
0x03,0xff,0x7f,0x91 = add	x3, x24, #4095, lsl #12         // =16773120
0xe8,0xcb,0x10,0x91 = add	x8, sp, #1074
0xbf,0xa3,0x3b,0x91 = add	sp, x29, #3816
0xe0,0xb7,0x3f,0x51 = sub	w0, wsp, #4077
0x84,0x8a,0x48,0x51 = sub	w4, w20, #546, lsl #12          // =2236416
0xff,0x83,0x04,0xd1 = sub	sp, sp, #288
0x7f,0x42,0x00,0x51 = sub	wsp, w19, #16
0xed,0x8e,0x44,0x31 = adds	w13, w23, #291, lsl #12         // =1191936
0x5f,0xfc,0x3f,0x31 = cmn	w2, #4095
0xf4,0x03,0x00,0x31 = adds	w20, wsp, #0
0x7f,0x04,0x40,0xb1 = cmn	x3, #1, lsl #12                 // =4096
0xff,0x53,0x40,0xf1 = cmp	sp, #20, lsl #12                // =81920
0xdf,0xff,0x3f,0xf1 = cmp	x30, #4095
0xe4,0xbb,0x3b,0xf1 = subs	x4, sp, #3822
0x7f,0x8c,0x44,0x31 = cmn	w3, #291, lsl #12               // =1191936
0xff,0x57,0x15,0x31 = cmn	wsp, #1365
0xff,0x13,0x51,0xb1 = cmn	sp, #1092, lsl #12              // =4472832
0x9f,0xb0,0x44,0xf1 = cmp	x4, #300, lsl #12               // =1228800
...
0x7f,0x1c,0x00,0x53 = uxtb	wzr, w3
0x49,0x3d,0x00,0x53 = uxth	w9, w10
0x20,0x3c,0x00,0x53 = uxth	w0, w1
...
0x61,0x00,0x80,0xf9 = prfm	pldl1strm, [x3]
0xa2,0x08,0x80,0xf9 = prfm	pldl2keep, [x5, #16]
0x43,0x00,0x80,0xf9 = prfm	pldl2strm, [x2]
0xa4,0x00,0x80,0xf9 = prfm	pldl3keep, [x5]
0xc5,0x00,0x80,0xf9 = prfm	pldl3strm, [x6]
0xe8,0x07,0x80,0xf9 = prfm	plil1keep, [sp, #8]
0x69,0x00,0x80,0xf9 = prfm	plil1strm, [x3]
0xaa,0x08,0x80,0xf9 = prfm	plil2keep, [x5, #16]
0x4b,0x00,0x80,0xf9 = prfm	plil2strm, [x2]
0xac,0x00,0x80,0xf9 = prfm	plil3keep, [x5]
0xcd,0x00,0x80,0xf9 = prfm	plil3strm, [x6]
0xf0,0x07,0x80,0xf9 = prfm	pstl1keep, [sp, #8]
0x71,0x00,0x80,0xf9 = prfm	pstl1strm, [x3]
0xb2,0x08,0x80,0xf9 = prfm	pstl2keep, [x5, #16]
0x53,0x00,0x80,0xf9 = prfm	pstl2strm, [x2]
0xb4,0x00,0x80,0xf9 = prfm	pstl3keep, [x5]
0xd5,0x00,0x80,0xf9 = prfm	pstl3strm, [x6]
0xef,0x03,0x80,0xf9 = prfm	plislcstrm, [sp]
...
0x06,0x68,0xa5,0xf8 = prfm	pldslckeep, [x0, x5]
...
0x5f,0xe6,0x02,0x72 = tst	w18, #0xcccccccc
0x93,0xe6,0x00,0x72 = ands	w19, w20, #0x33333333
0xd5,0xe6,0x01,0x72 = ands	w21, w22, #0x99999999
0x7f,0xf0,0x01,0x72 = tst	w3, #0xaaaaaaaa
0xff,0xf3,0x00,0x72 = tst	wzr, #0x55555555
...
0x5f,0xe6,0x02,0xf2 = tst	x18, #0xcccccccccccccccc
0x93,0xe6,0x00,0xf2 = ands	x19, x20, #0x3333333333333333
0xd5,0xe6,0x01,0xf2 = ands	x21, x22, #0x9999999999999999
0x7f,0xf0,0x01,0xf2 = tst	x3, #0xaaaaaaaaaaaaaaaa
0xff,0xf3,0x00,0xf2 = tst	xzr, #0x5555555555555555
0xe3,0x8f,0x00,0x32 = mov	w3, #983055                     // =0xf000f
0xea,0xf3,0x01,0xb2 = mov	x10, #-6148914691236517206      // =0xaaaaaaaaaaaaaaaa
...
0x42,0x9a,0x80,0x12 = mov	w2, #-1235                      // =0xfffffb2d
0x42,0x9a,0xc0,0xd2 = mov	x2, #5299989643264              // =0x4d200000000
...
0x2c,0xa3,0x18,0xd5 = msr	AMAIR2_EL1, x12
0x2c,0xa3,0x1d,0xd5 = msr	AMAIR2_EL12, x12
0x2c,0xa3,0x1c,0xd5 = msr	AMAIR2_EL2, x12
0x2c,0xa3,0x1e,0xd5 = msr	AMAIR2_EL3, x12
0x2c,0xa2,0x18,0xd5 = msr	MAIR2_EL1, x12
0x2c,0xa2,0x1d,0xd5 = msr	MAIR2_EL12, x12
0x2c,0xa1,0x1c,0xd5 = msr	MAIR2_EL2, x12
0x2c,0xa1,0x1e,0xd5 = msr	MAIR2_EL3, x12
0x4c,0xa2,0x18,0xd5 = msr	PIRE0_EL1, x12
0x4c,0xa2,0x1d,0xd5 = msr	PIRE0_EL12, x12
0x4c,0xa2,0x1c,0xd5 = msr	PIRE0_EL2, x12
0x6c,0xa2,0x18,0xd5 = msr	PIR_EL1, x12
0x6c,0xa2,0x1d,0xd5 = msr	PIR_EL12, x12
0x6c,0xa2,0x1c,0xd5 = msr	PIR_EL2, x12
0x6c,0xa2,0x1e,0xd5 = msr	PIR_EL3, x12
0xac,0xa2,0x1c,0xd5 = msr	S2PIR_EL2, x12
0x8c,0xa2,0x1b,0xd5 = msr	POR_EL0, x12
0x8c,0xa2,0x18,0xd5 = msr	POR_EL1, x12
0x8c,0xa2,0x1d,0xd5 = msr	POR_EL12, x12
0x8c,0xa2,0x1c,0xd5 = msr	POR_EL2, x12
0x8c,0xa2,0x1e,0xd5 = msr	POR_EL3, x12
0xac,0xa2,0x18,0xd5 = msr	S2POR_EL1, x12
0x6c,0x10,0x18,0xd5 = msr	SCTLR2_EL1, x12
0x6c,0x10,0x1d,0xd5 = msr	SCTLR2_EL12, x12
0x6c,0x10,0x1c,0xd5 = msr	SCTLR2_EL2, x12
0x6c,0x10,0x1e,0xd5 = msr	SCTLR2_EL3, x12
0x6c,0x20,0x18,0xd5 = msr	TCR2_EL1, x12
0x6c,0x20,0x1d,0xd5 = msr	TCR2_EL12, x12
0x6c,0x20,0x1c,0xd5 = msr	TCR2_EL2, x12
...
0xa9,0x03,0x38,0xd5 = mrs	x9, ID_DFR1_EL1
...
0xc9,0x03,0x38,0xd5 = mrs	x9, ID_MMFR5_EL1
...
0x49,0x04,0x38,0xd5 = mrs	x9, ID_AA64PFR2_EL1
...
0x69,0x07,0x38,0xd5 = mrs	x9, ID_AA64MMFR3_EL1
0x89,0x07,0x38,0xd5 = mrs	x9, ID_AA64MMFR4_EL1
...
0xc9,0x9e,0x38,0xd5 = mrs	x9, PMMIR_EL1
...
0x29,0xa3,0x38,0xd5 = mrs	x9, AMAIR2_EL1
0x29,0xa3,0x3d,0xd5 = mrs	x9, AMAIR2_EL12
0x29,0xa3,0x3c,0xd5 = mrs	x9, AMAIR2_EL2
0x29,0xa3,0x3e,0xd5 = mrs	x9, AMAIR2_EL3
0x29,0xa2,0x38,0xd5 = mrs	x9, MAIR2_EL1
0x29,0xa2,0x3d,0xd5 = mrs	x9, MAIR2_EL12
0x29,0xa1,0x3c,0xd5 = mrs	x9, MAIR2_EL2
0x29,0xa1,0x3e,0xd5 = mrs	x9, MAIR2_EL3
0x49,0xa2,0x38,0xd5 = mrs	x9, PIRE0_EL1
0x49,0xa2,0x3d,0xd5 = mrs	x9, PIRE0_EL12
0x49,0xa2,0x3c,0xd5 = mrs	x9, PIRE0_EL2
0x69,0xa2,0x38,0xd5 = mrs	x9, PIR_EL1
0x69,0xa2,0x3d,0xd5 = mrs	x9, PIR_EL12
0x69,0xa2,0x3c,0xd5 = mrs	x9, PIR_EL2
0x69,0xa2,0x3e,0xd5 = mrs	x9, PIR_EL3
0xa9,0xa2,0x3c,0xd5 = mrs	x9, S2PIR_EL2
0x89,0xa2,0x3b,0xd5 = mrs	x9, POR_EL0
0x89,0xa2,0x38,0xd5 = mrs	x9, POR_EL1
0x89,0xa2,0x3d,0xd5 = mrs	x9, POR_EL12
0x89,0xa2,0x3c,0xd5 = mrs	x9, POR_EL2
0x89,0xa2,0x3e,0xd5 = mrs	x9, POR_EL3
0xa9,0xa2,0x38,0xd5 = mrs	x9, S2POR_EL1
0x69,0x10,0x38,0xd5 = mrs	x9, SCTLR2_EL1
0x69,0x10,0x3d,0xd5 = mrs	x9, SCTLR2_EL12
0x69,0x10,0x3c,0xd5 = mrs	x9, SCTLR2_EL2
0x69,0x10,0x3e,0xd5 = mrs	x9, SCTLR2_EL3
0x69,0x20,0x38,0xd5 = mrs	x9, TCR2_EL1
0x69,0x20,0x3d,0xd5 = mrs	x9, TCR2_EL12
0x69,0x20,0x3c,0xd5 = mrs	x9, TCR2_EL2
0xac,0xf1,0x3f,0xd5 = mrs	x12, S3_7_C15_C1_5
0xed,0xbf,0x3a,0xd5 = mrs	x13, S3_2_C11_C15_7
0x2e,0x92,0x2b,0xd5 = sysl	x14, #3, c9, c2, #1
0x0c,0xf0,0x18,0xd5 = msr	S3_0_C15_C0_0, x12
0xe5,0xbd,0x1f,0xd5 = msr	S3_7_C11_C13_7, x5
0x24,0x92,0x0b,0xd5 = sys	#3, c9, c2, #1, x4
