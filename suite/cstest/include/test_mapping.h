...
static const TestModeMapEntry test_mode_map[] = {
	...
	{ .str = "CS_MODE_MOS65XX_65816_LONG_M",
	  .mode = CS_MODE_MOS65XX_65816_LONG_M },
	{ .str = "CS_MODE_MOS65XX_65816_LONG_X",
	  .mode = CS_MODE_MOS65XX_65816_LONG_X },
	{ .str = "CS_MODE_MOS65XX_65816_LONG_MX",
	  .mode = CS_MODE_MOS65XX_65816_LONG_M | CS_MODE_MOS65XX_65816_LONG_X },
...
///
/// You can sort the table with python.
/// Copy the table into a file and run:
///
/// ```python
/// with open("/tmp/file_with_table_entries") as f:
///     text = f.readlines()
///
/// text.sort()
/// print(''.join(text))
...
static const TestCSEnumEntry cs_enum_map[] = {
	...
	{ .id = "AARCH64_OP_SVEVECLENSPECIFIER",
