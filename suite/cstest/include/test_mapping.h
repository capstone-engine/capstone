...
static const cs_enum_id_map test_mode_map[] = {
	...
	{ .str = "CS_MODE_RISCV_EXPERIMENTAL_ZICFISS", .val = CS_MODE_RISCV_ZICFISS},
...
static const cs_enum_id_map cs_enum_map[] = {
	...
	{ .str = "RISCV_FEATURE_HasHalfFPLoadStoreMove", .val = RISCV_FEATURE_HASHALFFPLOADSTOREMOVE },
	{ .str = "RISCV_FEATURE_HasRVCHints", .val = RISCV_FEATURE_HASRVCHINTS },
	{ .str = "RISCV_FEATURE_HasStdExtA", .val = RISCV_FEATURE_HASSTDEXTA },
	{ .str = "RISCV_FEATURE_HasStdExtC", .val = RISCV_FEATURE_HASSTDEXTC },
	{ .str = "RISCV_FEATURE_HasStdExtCOrZca", .val = RISCV_FEATURE_HASSTDEXTCORZCA },
	{ .str = "RISCV_FEATURE_HasStdExtCOrZcd", .val = RISCV_FEATURE_HASSTDEXTCORZCD },
	{ .str = "RISCV_FEATURE_HasStdExtCOrZcfOrZce", .val = RISCV_FEATURE_HASSTDEXTCORZCFORZCE },
	...
	{ .str = "RISCV_FEATURE_HasStdExtMOrZmmul", .val = RISCV_FEATURE_HASSTDEXTMORZMMUL },
	{ .str = "RISCV_FEATURE_HasStdExtSvinval", .val = RISCV_FEATURE_HASSTDEXTSVINVAL },
	{ .str = "RISCV_FEATURE_HasStdExtZacas", .val = RISCV_FEATURE_HASSTDEXTZACAS },
	{ .str = "RISCV_FEATURE_HasStdExtZawrs", .val = RISCV_FEATURE_HASSTDEXTZAWRS },
	{ .str = "RISCV_FEATURE_HasStdExtZba", .val = RISCV_FEATURE_HASSTDEXTZBA },
	{ .str = "RISCV_FEATURE_HasStdExtZbb", .val = RISCV_FEATURE_HASSTDEXTZBB },
	{ .str = "RISCV_FEATURE_HasStdExtZbbOrZbkb", .val = RISCV_FEATURE_HASSTDEXTZBBORZBKB },
	{ .str = "RISCV_FEATURE_HasStdExtZbc", .val = RISCV_FEATURE_HASSTDEXTZBC },
	{ .str = "RISCV_FEATURE_HasStdExtZbcOrZbkc", .val = RISCV_FEATURE_HASSTDEXTZBCORZBKC },
	{ .str = "RISCV_FEATURE_HasStdExtZbkb", .val = RISCV_FEATURE_HASSTDEXTZBKB },
	{ .str = "RISCV_FEATURE_HasStdExtZbkc", .val = RISCV_FEATURE_HASSTDEXTZBKC },
	{ .str = "RISCV_FEATURE_HasStdExtZbkx", .val = RISCV_FEATURE_HASSTDEXTZBKX },
	{ .str = "RISCV_FEATURE_HasStdExtZbs", .val = RISCV_FEATURE_HASSTDEXTZBS },
	{ .str = "RISCV_FEATURE_HasStdExtZcb", .val = RISCV_FEATURE_HASSTDEXTZCB },
	{ .str = "RISCV_FEATURE_HasStdExtZcmop", .val = RISCV_FEATURE_HASSTDEXTZCMOP },
	{ .str = "RISCV_FEATURE_HasStdExtZcmp", .val = RISCV_FEATURE_HASSTDEXTZCMP },
	{ .str = "RISCV_FEATURE_HasStdExtZcmt", .val = RISCV_FEATURE_HASSTDEXTZCMT },
	{ .str = "RISCV_FEATURE_HasStdExtZdinx", .val = RISCV_FEATURE_HASSTDEXTZDINX },
	{ .str = "RISCV_FEATURE_HasStdExtZfa", .val = RISCV_FEATURE_HASSTDEXTZFA },
	{ .str = "RISCV_FEATURE_HasStdExtZfbfmin", .val = RISCV_FEATURE_HASSTDEXTZFBFMIN },
	{ .str = "RISCV_FEATURE_HasStdExtZfh", .val = RISCV_FEATURE_HASSTDEXTZFH },
	{ .str = "RISCV_FEATURE_HasStdExtZfhOrZvfh", .val = RISCV_FEATURE_HASSTDEXTZFHORZVFH },
	{ .str = "RISCV_FEATURE_HasStdExtZfhmin", .val = RISCV_FEATURE_HASSTDEXTZFHMIN },
	{ .str = "RISCV_FEATURE_HasStdExtZfinx", .val = RISCV_FEATURE_HASSTDEXTZFINX },
	{ .str = "RISCV_FEATURE_HasStdExtZhinx", .val = RISCV_FEATURE_HASSTDEXTZHINX },
	{ .str = "RISCV_FEATURE_HasStdExtZhinxmin", .val = RISCV_FEATURE_HASSTDEXTZHINXMIN },
	{ .str = "RISCV_FEATURE_HasStdExtZicbom", .val = RISCV_FEATURE_HASSTDEXTZICBOM },
	{ .str = "RISCV_FEATURE_HasStdExtZicbop", .val = RISCV_FEATURE_HASSTDEXTZICBOP },
	{ .str = "RISCV_FEATURE_HasStdExtZicboz", .val = RISCV_FEATURE_HASSTDEXTZICBOZ },
	{ .str = "RISCV_FEATURE_HasStdExtZicfilp", .val = RISCV_FEATURE_HASSTDEXTZICFILP },
	{ .str = "RISCV_FEATURE_HasStdExtZicfiss", .val = RISCV_FEATURE_HASSTDEXTZICFISS },
	{ .str = "RISCV_FEATURE_HasStdExtZicond", .val = RISCV_FEATURE_HASSTDEXTZICOND },
	{ .str = "RISCV_FEATURE_HasStdExtZicsr", .val = RISCV_FEATURE_HASSTDEXTZICSR },
	{ .str = "RISCV_FEATURE_HasStdExtZifencei", .val = RISCV_FEATURE_HASSTDEXTZIFENCEI },
	{ .str = "RISCV_FEATURE_HasStdExtZihintntl", .val = RISCV_FEATURE_HASSTDEXTZIHINTNTL },
	{ .str = "RISCV_FEATURE_HasStdExtZihintpause", .val = RISCV_FEATURE_HASSTDEXTZIHINTPAUSE },
	{ .str = "RISCV_FEATURE_HasStdExtZimop", .val = RISCV_FEATURE_HASSTDEXTZIMOP },
	{ .str = "RISCV_FEATURE_HasStdExtZknd", .val = RISCV_FEATURE_HASSTDEXTZKND },
	{ .str = "RISCV_FEATURE_HasStdExtZkndOrZkne", .val = RISCV_FEATURE_HASSTDEXTZKNDORZKNE },
	{ .str = "RISCV_FEATURE_HasStdExtZkne", .val = RISCV_FEATURE_HASSTDEXTZKNE },
	{ .str = "RISCV_FEATURE_HasStdExtZknh", .val = RISCV_FEATURE_HASSTDEXTZKNH },
	{ .str = "RISCV_FEATURE_HasStdExtZkr", .val = RISCV_FEATURE_HASSTDEXTZKR },
	{ .str = "RISCV_FEATURE_HasStdExtZksed", .val = RISCV_FEATURE_HASSTDEXTZKSED },
	{ .str = "RISCV_FEATURE_HasStdExtZksh", .val = RISCV_FEATURE_HASSTDEXTZKSH },
	{ .str = "RISCV_FEATURE_HasStdExtZtso", .val = RISCV_FEATURE_HASSTDEXTZTSO },
	{ .str = "RISCV_FEATURE_HasStdExtZvbb", .val = RISCV_FEATURE_HASSTDEXTZVBB },
	{ .str = "RISCV_FEATURE_HasStdExtZvbc", .val = RISCV_FEATURE_HASSTDEXTZVBC },
	{ .str = "RISCV_FEATURE_HasStdExtZvfbfmin", .val = RISCV_FEATURE_HASSTDEXTZVFBFMIN },
	{ .str = "RISCV_FEATURE_HasStdExtZvfbfwma", .val = RISCV_FEATURE_HASSTDEXTZVFBFWMA },
	{ .str = "RISCV_FEATURE_HasStdExtZvkb", .val = RISCV_FEATURE_HASSTDEXTZVKB },
	{ .str = "RISCV_FEATURE_HasStdExtZvkg", .val = RISCV_FEATURE_HASSTDEXTZVKG },
	{ .str = "RISCV_FEATURE_HasStdExtZvkned", .val = RISCV_FEATURE_HASSTDEXTZVKNED },
	{ .str = "RISCV_FEATURE_HasStdExtZvknha", .val = RISCV_FEATURE_HASSTDEXTZVKNHA },
	{ .str = "RISCV_FEATURE_HasStdExtZvknhaOrZvknhb", .val = RISCV_FEATURE_HASSTDEXTZVKNHAORZVKNHB },
	{ .str = "RISCV_FEATURE_HasStdExtZvknhb", .val = RISCV_FEATURE_HASSTDEXTZVKNHB },
	{ .str = "RISCV_FEATURE_HasStdExtZvksed", .val = RISCV_FEATURE_HASSTDEXTZVKSED },
	{ .str = "RISCV_FEATURE_HasStdExtZvksh", .val = RISCV_FEATURE_HASSTDEXTZVKSH },
	{ .str = "RISCV_FEATURE_HasVInstructions", .val = RISCV_FEATURE_HASVINSTRUCTIONS },
	{ .str = "RISCV_FEATURE_HasVInstructionsAnyF", .val = RISCV_FEATURE_HASVINSTRUCTIONSANYF },
	{ .str = "RISCV_FEATURE_HasVInstructionsF16Minimal", .val = RISCV_FEATURE_HASVINSTRUCTIONSF16MINIMAL },
	{ .str = "RISCV_FEATURE_HasVInstructionsI64", .val = RISCV_FEATURE_HASVINSTRUCTIONSI64 },
	{ .str = "RISCV_FEATURE_HasVendorXCValu", .val = RISCV_FEATURE_HASVENDORXCVALU },
	{ .str = "RISCV_FEATURE_HasVendorXCVbi", .val = RISCV_FEATURE_HASVENDORXCVBI },
	{ .str = "RISCV_FEATURE_HasVendorXCVbitmanip", .val = RISCV_FEATURE_HASVENDORXCVBITMANIP },
	{ .str = "RISCV_FEATURE_HasVendorXCVelw", .val = RISCV_FEATURE_HASVENDORXCVELW },
	{ .str = "RISCV_FEATURE_HasVendorXCVmac", .val = RISCV_FEATURE_HASVENDORXCVMAC },
	{ .str = "RISCV_FEATURE_HasVendorXCVmem", .val = RISCV_FEATURE_HASVENDORXCVMEM },
	{ .str = "RISCV_FEATURE_HasVendorXCVsimd", .val = RISCV_FEATURE_HASVENDORXCVSIMD },
	{ .str = "RISCV_FEATURE_HasVendorXSfvcp", .val = RISCV_FEATURE_HASVENDORXSFVCP },
	{ .str = "RISCV_FEATURE_HasVendorXSfvfnrclipxfqf", .val = RISCV_FEATURE_HASVENDORXSFVFNRCLIPXFQF },
	{ .str = "RISCV_FEATURE_HasVendorXSfvfwmaccqqq", .val = RISCV_FEATURE_HASVENDORXSFVFWMACCQQQ },
	{ .str = "RISCV_FEATURE_HasVendorXSfvqmaccdod", .val = RISCV_FEATURE_HASVENDORXSFVQMACCDOD },
	{ .str = "RISCV_FEATURE_HasVendorXSfvqmaccqoq", .val = RISCV_FEATURE_HASVENDORXSFVQMACCQOQ },
	{ .str = "RISCV_FEATURE_HasVendorXTHeadBa", .val = RISCV_FEATURE_HASVENDORXTHEADBA },
	{ .str = "RISCV_FEATURE_HasVendorXTHeadBb", .val = RISCV_FEATURE_HASVENDORXTHEADBB },
	{ .str = "RISCV_FEATURE_HasVendorXTHeadBs", .val = RISCV_FEATURE_HASVENDORXTHEADBS },
	{ .str = "RISCV_FEATURE_HasVendorXTHeadCmo", .val = RISCV_FEATURE_HASVENDORXTHEADCMO },
	{ .str = "RISCV_FEATURE_HasVendorXTHeadCondMov", .val = RISCV_FEATURE_HASVENDORXTHEADCONDMOV },
	{ .str = "RISCV_FEATURE_HasVendorXTHeadFMemIdx", .val = RISCV_FEATURE_HASVENDORXTHEADFMEMIDX },
	{ .str = "RISCV_FEATURE_HasVendorXTHeadMac", .val = RISCV_FEATURE_HASVENDORXTHEADMAC },
	{ .str = "RISCV_FEATURE_HasVendorXTHeadMemIdx", .val = RISCV_FEATURE_HASVENDORXTHEADMEMIDX },
	{ .str = "RISCV_FEATURE_HasVendorXTHeadMemPair", .val = RISCV_FEATURE_HASVENDORXTHEADMEMPAIR },
	{ .str = "RISCV_FEATURE_HasVendorXTHeadSync", .val = RISCV_FEATURE_HASVENDORXTHEADSYNC },
	{ .str = "RISCV_FEATURE_HasVendorXTHeadVdot", .val = RISCV_FEATURE_HASVENDORXTHEADVDOT },
	{ .str = "RISCV_FEATURE_HasVendorXVentanaCondOps", .val = RISCV_FEATURE_HASVENDORXVENTANACONDOPS },
