// https://github.com/aquynh/capstone/issues/1323
!# issue 1323
...
0x00,0x00,0x02,0xb6 == tbz x0, #0x20, #0x4000 
!# issue 1144
!#CS_ARCH_ARM64, CS_MODE_LITTLE_ENDIAN, None
0x00,0x00,0x04,0xb6 == tbz x0, #0x20, #0xffffffffffff8004
!# issue 1144
!#CS_ARCH_ARM64, CS_MODE_LITTLE_ENDIAN, None
0x00,0x00,0x02,0xb7 == tbnz x0, #0x20, #0x4008
!# issue 1144
!#CS_ARCH_ARM64, CS_MODE_LITTLE_ENDIAN, None
0x00,0x00,0x04,0xb7 == tbnz x0, #0x20, #0xffffffffffff800c
!# issue 826
...
!# issue 470
!#CS_ARCH_X86, CS_MODE_32, None
0x0f,0x01,0x05,0xa0,0x90,0x04,0x08 == sgdt [0x80490a0]
!# issue 470
!#CS_ARCH_X86, CS_MODE_32, None
0x0f,0x01,0x0d,0xa7,0x90,0x04,0x08 == sidt [0x80490a7]
!# issue 470
!#CS_ARCH_X86, CS_MODE_32, None
0x0f,0x01,0x15,0xa0,0x90,0x04,0x08 == lgdt [0x80490a0]
!# issue 470
!#CS_ARCH_X86, CS_MODE_32, None
0x0f,0x01,0x1d,0xa7,0x90,0x04,0x08 == lidt [0x80490a7]
!# issue 459
!#CS_ARCH_ARM, CS_MODE_ARM, CS_OPT_DETAIL
...
0xe8,0x35,0x64 == call 0x6438 
!# issue 456
!#CS_ARCH_X86, CS_MODE_16, None
0xe9,0x35,0x64 == jmp 0x643b
!# issue 456
!#CS_ARCH_X86, CS_MODE_16, None
0x66,0xe9,0x35,0x64,0x93,0x53 == jmp 0x53936441
!# issue 456
!#CS_ARCH_X86, CS_MODE_16, None
0x66,0xe8,0x35,0x64,0x93,0x53 == call 0x53936447
!# issue 456
!#CS_ARCH_X86, CS_MODE_16, None
0x66,0xe9,0x35,0x64,0x93,0x53 == jmp 0x5393644d
!# issue 456
!#CS_ARCH_X86, CS_MODE_32, None
0x66,0xe8,0x35,0x64 == call 0x6439
!# issue 456
!#CS_ARCH_X86, CS_MODE_32, None
0xe9,0x35,0x64,0x93,0x53 == jmp 0x5393643e
!# issue 456
!#CS_ARCH_X86, CS_MODE_32, None
0x66,0xe9,0x35,0x64 == jmp 0x6446
!# issue 458
!#CS_ARCH_X86, CS_MODE_32, CS_OPT_DETAIL
...
!# issue 454
!#CS_ARCH_X86, CS_MODE_32, None
0xf2,0x6c == repne insb byte ptr es:[edi], dx
!# issue 454
!#CS_ARCH_X86, CS_MODE_32, None
0xf2,0x6d == repne insd dword ptr es:[edi], dx
!# issue 454
!#CS_ARCH_X86, CS_MODE_32, None
0xf2,0x6e == repne outsb dx, byte ptr [esi]
!# issue 454
!#CS_ARCH_X86, CS_MODE_32, None
0xf2,0x6f == repne outsd dx, dword ptr [esi]
!# issue 454
!#CS_ARCH_X86, CS_MODE_32, None
0xf2,0xac == repne lodsb al, byte ptr [esi]
!# issue 454
!#CS_ARCH_X86, CS_MODE_32, None
0xf2,0xad == repne lodsd eax, dword ptr [esi]
!# issue 450
!#CS_ARCH_X86, CS_MODE_32, CS_OPT_DETAIL
...
!# issue 298
!#CS_ARCH_X86, CS_MODE_32, None
0x66,0xf3,0xf2,0x0f,0x59,0xff == mulsd xmm7, xmm7
!# issue 298
!#CS_ARCH_X86, CS_MODE_32, None
0xf2,0x66,0x0f,0x59,0xff == mulpd xmm7, xmm7
!# issue 294
!#CS_ARCH_X86, CS_MODE_32, CS_OPT_DETAIL
...
!# issue 264
!#CS_ARCH_ARM, CS_MODE_THUMB, None
0x17,0x20 == moveq r0, #0x17
!# issue 264
!#CS_ARCH_ARM, CS_MODE_THUMB, None
0x4f,0xf0,0xff,0x30 == movne.w r0, #-1
!# issue 246
!#CS_ARCH_ARM, CS_MODE_THUMB, None
...
!# issue 151
!#CS_ARCH_X86, CS_MODE_64, None
0x4d,0x8d,0x3d,0x02,0x00,0x00,0x00 == lea r15, [rip + 2]
!# issue 151
!#CS_ARCH_X86, CS_MODE_64, None
0xeb,0xb0 == jmp 0xffffffffffffffb9
!# issue 134
