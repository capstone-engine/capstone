...
struct cs_struct {
	...
	size_t insn_cache_size;
	bool checkinsn;	// set this to True if we check instruction when disassembling
	cs_opt_checkinsn checkinsn_setup;	// user-defined checkinsn setup
};
