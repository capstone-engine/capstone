...
SYSZ_OP_INVALID = GENERIC_OP_INVALID
SYSZ_OP_REG = GENERIC_OP_REG
SYSZ_OP_IMM = GENERIC_OP_IMM
SYSZ_OP_MEM = GENERIC_OP_MEM
SYSZ_OP_ACREG = GENERIC_OP_ARCH_SPECIFIC
...
SYSZ_GRP_JUMP = GENERIC_GRP_JUMP
SYSZ_GRP_DISTINCTOPS = GENERIC_GRP_ARCH_SPECIFIC
SYSZ_GRP_FPEXTENSION = 683
SYSZ_GRP_HIGHWORD = 684
SYSZ_GRP_INTERLOCKEDACCESS1 = 685
SYSZ_GRP_LOADSTOREONCOND = 686
SYSZ_GRP_ENDING = 687
