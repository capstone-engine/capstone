...
let _M680X_REG_TMP1 = 20;;
let _M680X_REG_TMP2 = 21;;
let _M680X_REG_TMP3 = 22;;
let _M680X_REG_ENDING = 23;;
...
let _M680X_INS_STA = 297;;
let _M680X_INS_STAA = 298;;
let _M680X_INS_STAB = 299;;
let _M680X_INS_STB = 300;;
let _M680X_INS_STBT = 301;;
let _M680X_INS_STD = 302;;
let _M680X_INS_STE = 303;;
let _M680X_INS_STF = 304;;
let _M680X_INS_STOP = 305;;
let _M680X_INS_STHX = 306;;
let _M680X_INS_STQ = 307;;
let _M680X_INS_STS = 308;;
let _M680X_INS_STU = 309;;
let _M680X_INS_STW = 310;;
let _M680X_INS_STX = 311;;
let _M680X_INS_STY = 312;;
let _M680X_INS_SUB = 313;;
let _M680X_INS_SUBA = 314;;
let _M680X_INS_SUBB = 315;;
let _M680X_INS_SUBD = 316;;
let _M680X_INS_SUBE = 317;;
let _M680X_INS_SUBF = 318;;
let _M680X_INS_SUBR = 319;;
let _M680X_INS_SUBW = 320;;
let _M680X_INS_SWI = 321;;
let _M680X_INS_SWI2 = 322;;
let _M680X_INS_SWI3 = 323;;
let _M680X_INS_SYNC = 324;;
let _M680X_INS_TAB = 325;;
let _M680X_INS_TAP = 326;;
let _M680X_INS_TAX = 327;;
let _M680X_INS_TBA = 328;;
let _M680X_INS_TBEQ = 329;;
let _M680X_INS_TBL = 330;;
let _M680X_INS_TBNE = 331;;
let _M680X_INS_TEST = 332;;
let _M680X_INS_TFM = 333;;
let _M680X_INS_TFR = 334;;
let _M680X_INS_TIM = 335;;
let _M680X_INS_TPA = 336;;
let _M680X_INS_TST = 337;;
let _M680X_INS_TSTA = 338;;
let _M680X_INS_TSTB = 339;;
let _M680X_INS_TSTD = 340;;
let _M680X_INS_TSTE = 341;;
let _M680X_INS_TSTF = 342;;
let _M680X_INS_TSTW = 343;;
let _M680X_INS_TSTX = 344;;
let _M680X_INS_TSX = 345;;
let _M680X_INS_TSY = 346;;
let _M680X_INS_TXA = 347;;
let _M680X_INS_TXS = 348;;
let _M680X_INS_TYS = 349;;
let _M680X_INS_WAI = 350;;
let _M680X_INS_WAIT = 351;;
let _M680X_INS_WAV = 352;;
let _M680X_INS_WAVR = 353;;
let _M680X_INS_XGDX = 354;;
let _M680X_INS_XGDY = 355;;
let _M680X_INS_ENDING = 356;;
