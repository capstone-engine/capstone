...
let _CS_OP_FP      = 3;;  (* Floating-Point operand. *)
let _CS_OP_PRED    = 4;;  (* Predicate operand. *)
let _CS_OP_SPECIAL = 0x10;; (* Special operand *)
let _CS_OP_MEM     = 0x80;;  (* Memory operand. *)
let _CS_OP_MEM_REG = _CS_OP_MEM lor _CS_OP_REG;;  (* Memory referencing register operand *)
let _CS_OP_MEM_IMM = _CS_OP_MEM lor _CS_OP_IMM;;  (* Memory referencing immediate operand *)
