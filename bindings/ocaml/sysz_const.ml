...
let _SYSZ_OP_INVALID = _GENERIC_OP_INVALID;;
let _SYSZ_OP_REG = _GENERIC_OP_REG;;
let _SYSZ_OP_IMM = _GENERIC_OP_IMM;;
let _SYSZ_OP_MEM = _GENERIC_OP_MEM;;
let _SYSZ_OP_ACREG = _GENERIC_OP_ARCH_SPECIFIC;;
...
let _SYSZ_GRP_INVALID = _GENERIC_GRP_INVALID;;
let _SYSZ_GRP_JUMP = _GENERIC_GRP_JUMP;;
let _SYSZ_GRP_DISTINCTOPS = _GENERIC_GRP_ARCH_SPECIFIC;;
let _SYSZ_GRP_FPEXTENSION = 683;;
let _SYSZ_GRP_HIGHWORD = 684;;
let _SYSZ_GRP_INTERLOCKEDACCESS1 = 685;;
let _SYSZ_GRP_LOADSTOREONCOND = 686;;
let _SYSZ_GRP_ENDING = 687;;
