...
let _AARCH64_CODE = "\x21\x7c\x02\x9b\x21\x7c\x00\x53\x00\x40\x21\x4b\xe1\x0b\x40\xb9";;
...
let all_tests = [
	...
	(CS_ARCH_AARCH64, [CS_MODE_ARM], _AARCH64_CODE, "AArch64", 0L);
	...
	(CS_ARCH_MIPS, [CS_MODE_MIPS64; CS_MODE_LITTLE_ENDIAN], _MIPS_CODE2, "MIPS-64-EL (Little-endian)", 0L);
        ...
        (CS_ARCH_SYSTEMZ, [CS_MODE_LITTLE_ENDIAN], _SYSTEMZ_CODE, "SystemZ", 0L);
