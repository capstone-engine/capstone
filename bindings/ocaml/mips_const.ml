...
let _MIPS_OP_INVALID = _GENERIC_OP_INVALID;;
let _MIPS_OP_REG = _GENERIC_OP_REG;;
let _MIPS_OP_IMM = _GENERIC_OP_IMM;;
let _MIPS_OP_MEM = _GENERIC_OP_MEM;;
...
let _MIPS_GRP_INVALID = _GENERIC_GRP_INVALID;;
let _MIPS_GRP_JUMP = _GENERIC_GRP_JUMP;;
let _MIPS_GRP_BITCOUNT = _GENERIC_GRP_ARCH_SPECIFIC;;
let _MIPS_GRP_DSP = 587;;
let _MIPS_GRP_DSPR2 = 588;;
let _MIPS_GRP_FPIDX = 589;;
let _MIPS_GRP_MSA = 590;;
let _MIPS_GRP_MIPS32R2 = 591;;
let _MIPS_GRP_MIPS64 = 592;;
let _MIPS_GRP_MIPS64R2 = 593;;
let _MIPS_GRP_SEINREG = 594;;
let _MIPS_GRP_STDENC = 595;;
let _MIPS_GRP_SWAP = 596;;
let _MIPS_GRP_MICROMIPS = 597;;
let _MIPS_GRP_MIPS16MODE = 598;;
let _MIPS_GRP_FP64BIT = 599;;
let _MIPS_GRP_NONANSFPMATH = 600;;
let _MIPS_GRP_NOTFP64BIT = 601;;
let _MIPS_GRP_NOTINMICROMIPS = 602;;
let _MIPS_GRP_NOTNACL = 603;;
let _MIPS_GRP_NOTMIPS32R6 = 604;;
let _MIPS_GRP_NOTMIPS64R6 = 605;;
let _MIPS_GRP_CNMIPS = 606;;
let _MIPS_GRP_MIPS32 = 607;;
let _MIPS_GRP_MIPS32R6 = 608;;
let _MIPS_GRP_MIPS64R6 = 609;;
let _MIPS_GRP_MIPS2 = 610;;
let _MIPS_GRP_MIPS3 = 611;;
let _MIPS_GRP_MIPS3_32 = 612;;
let _MIPS_GRP_MIPS3_32R2 = 613;;
let _MIPS_GRP_MIPS4_32 = 614;;
let _MIPS_GRP_MIPS4_32R2 = 615;;
let _MIPS_GRP_MIPS5_32R2 = 616;;
let _MIPS_GRP_GP32BIT = 617;;
let _MIPS_GRP_GP64BIT = 618;;
let _MIPS_GRP_ENDING = 619;;
