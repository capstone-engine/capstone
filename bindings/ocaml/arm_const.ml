...
let _ARM_OP_INVALID = _GENERIC_OP_INVALID;;
let _ARM_OP_REG = _GENERIC_OP_REG;;
let _ARM_OP_FP = _GENERIC_OP_FP;;
let _ARM_OP_MEM = _GENERIC_OP_MEM;;
let _ARM_OP_IMM = _GENERIC_OP_IMM;;
let _ARM_OP_CIMM = _GENERIC_OP_ARCH_SPECIFIC;;
let _ARM_OP_PIMM = 279;;
let _ARM_OP_SETEND = 280;;
let _ARM_OP_SYSREG = 281;;
...
let _ARM_GRP_INVALID = _GENERIC_GRP_INVALID;;
let _ARM_GRP_JUMP = _GENERIC_GRP_JUMP;;
let _ARM_GRP_CRYPTO = _GENERIC_GRP_ARCH_SPECIFIC;;
let _ARM_GRP_DATABARRIER = 436;;
let _ARM_GRP_DIVIDE = 437;;
let _ARM_GRP_FPARMV8 = 438;;
let _ARM_GRP_MULTPRO = 439;;
let _ARM_GRP_NEON = 440;;
let _ARM_GRP_T2EXTRACTPACK = 441;;
let _ARM_GRP_THUMB2DSP = 442;;
let _ARM_GRP_TRUSTZONE = 443;;
let _ARM_GRP_V4T = 444;;
let _ARM_GRP_V5T = 445;;
let _ARM_GRP_V5TE = 446;;
let _ARM_GRP_V6 = 447;;
let _ARM_GRP_V6T2 = 448;;
let _ARM_GRP_V7 = 449;;
let _ARM_GRP_V8 = 450;;
let _ARM_GRP_VFP2 = 451;;
let _ARM_GRP_VFP3 = 452;;
let _ARM_GRP_VFP4 = 453;;
let _ARM_GRP_ARM = 454;;
let _ARM_GRP_MCLASS = 455;;
let _ARM_GRP_NOTMCLASS = 456;;
let _ARM_GRP_THUMB = 457;;
let _ARM_GRP_THUMB1ONLY = 458;;
let _ARM_GRP_THUMB2 = 459;;
let _ARM_GRP_PREV8 = 460;;
let _ARM_GRP_FPVMLX = 461;;
let _ARM_GRP_MULOPS = 462;;
let _ARM_GRP_CRC = 463;;
let _ARM_GRP_DPVFP = 464;;
let _ARM_GRP_V6M = 465;;
let _ARM_GRP_ENDING = 466;;
