...
public class Capstone {
  ...
  public static final int CS_GRP_BRANCH  = 7;  // all branch instructions
  public static final int CS_GRP_BRANCH_RELATIVE = 8;  // all indirect branch instructions
  public static final int CS_GRP_BRANCH_INDIRECT = 9;  // all indirect branch instructions
