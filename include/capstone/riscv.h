...
typedef enum riscv_insn {
	...
	// clang-format on
	// generated content <RISCVenCSInsnEnum.inc> end
  	RISCV_INS_ENDING,

	RISCV_INS_ALIAS_BEGIN,
	// generated content <RISCV_GenCSAliasEnum.inc> begin
	// clang-format off

	// clang-format on
	// generated content <RISCV_GenCSInsnEnum.inc> end
	RISCV__INS_ALIAS_END,
} riscv_insn;
