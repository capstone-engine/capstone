...
#define X86_EFLAGS_RESET_ZF (1ULL << 46)
#define X86_EFLAG_MODIFY_CF (1ULL << 47)
#define X86_EFLAGS_RESET_RF (1ULL << 48)
#define X86_EFLAGS_TEST_AF (1ULL << 49)
#define X86_EFLAGS_TEST_IF (1ULL << 50)
#define X86_EFLAGS_TEST_RF (1ULL << 51)
#define X86_EFLAGS_TEST_TF (1ULL << 52)
#define X86_EFLAGS_SET_OF (1ULL << 53)
#define X86_EFLAGS_SET_SF (1ULL << 54)
#define X86_EFLAGS_SET_ZF (1ULL << 55)
#define X86_EFLAGS_SET_AF (1ULL << 55)
#define X86_EFLAGS_SET_PF (1ULL << 56)
#define X86_FPUFLAGS_MODIFY_C0 (1ULL<<0)
#define X86_FPUFLAGS_MODIFY_C1 (1ULL<<1)
#define X86_FPUFLAGS_MODIFY_C2 (1ULL<<2)
#define X86_FPUFLAGS_MODIFY_C3 (1ULL<<3)
#define X86_FPUFLAGS_RESET_C0 (1ULL<<4)
#define X86_FPUFLAGS_RESET_C1 (1ULL<<5)
#define X86_FPUFLAGS_RESET_C2 (1ULL<<6)
#define X86_FPUFLAGS_RESET_C3 (1ULL<<7)
#define X86_FPUFLAGS_SET_C0 (1ULL<<8)
#define X86_FPUFLAGS_SET_C1 (1ULL<<9)
#define X86_FPUFLAGS_SET_C2 (1ULL<<10)
#define X86_FPUFLAGS_SET_C3 (1ULL<<11)
#define X86_FPUFLAGS_UNDEFINED_C0 (1ULL<<12)
#define X86_FPUFLAGS_UNDEFINED_C1 (1ULL<<13)
#define X86_FPUFLAGS_UNDEFINED_C2 (1ULL<<14)
#define X86_FPUFLAGS_UNDEFINED_C3 (1ULL<<15)
