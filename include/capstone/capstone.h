...
#else
#pragma message( \
	"WARNING: You need to implement CAPSTONE_DEPRECATED for this compiler")
...
#define CS_VERSION_PRE_RELEASE CS_VERSION_ALPHA12
...
typedef enum cs_mode {
	...
	CS_MODE_APPLE_PROPRIETARY =
		1
		<< CS_MODE_VENDOR_AARCH64_BIT0, ///< Enable Apple proprietary AArch64 instructions like AMX, MUL53, and others.
	// SPARC
...
typedef int(CAPSTONE_API *cs_vsnprintf_t)(char *str, size_t size,
...
*/
typedef size_t(CAPSTONE_API *cs_skipdata_cb_t)(const uint8_t *code,
...
*/
CAPSTONE_EXPORT
bool CAPSTONE_API cs_insn_group(csh handle, const cs_insn *insn,
...
*/
CAPSTONE_EXPORT
bool CAPSTONE_API cs_reg_read(csh handle, const cs_insn *insn,
			      unsigned int reg_id);
...
*/
CAPSTONE_EXPORT
bool CAPSTONE_API cs_reg_write(csh handle, const cs_insn *insn,
			       unsigned int reg_id);
...
*/
CAPSTONE_EXPORT
int CAPSTONE_API cs_op_count(csh handle, const cs_insn *insn,
...
*/
CAPSTONE_EXPORT
int CAPSTONE_API cs_op_index(csh handle, const cs_insn *insn,
			     unsigned int op_type, unsigned int position);
